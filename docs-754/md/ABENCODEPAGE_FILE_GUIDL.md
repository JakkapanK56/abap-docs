---
title: "Code Pages for Files - ABAP Keyword Documentation"
...
When you open text files on the [host computer](ABENHOST_COMPUTER_GLOSRY.md "Glossary Entry") of the current AS Instance using the OPEN DATASET statement, you specify the following options that are very important for internationalization:
