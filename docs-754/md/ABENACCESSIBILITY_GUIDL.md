---
title: "Accessibility - ABAP Keyword Documentation"
...
Accessibility is a [product standard](ABENCORRECTNESS_QUALITY_GUIDL.md "Guideline") that ensures that information technology products can also be used by people with impairments. For user interfaces, for instance, this means meeting the needs of visually impaired or blind users in particular. These users usually need a screen reader program, which reads the content of the screen aloud.
