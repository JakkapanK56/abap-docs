---
title: "Using Pretty Printer - ABAP Keyword Documentation"
...
-   Indent statements
    Absolutely essential for a logical program structure that is clearly visible. A [maximum of one statement per program line](ABENSTATEMENT_GUIDL.md "Guideline") is allowed.
...
-   Uppercase keywords
    Makes it easier to [understand the source code](ABENLOWER_UPPER_CASE_GUIDL.md "Guideline") in printed form. In this case, syntax color-coding is usually not visible.
