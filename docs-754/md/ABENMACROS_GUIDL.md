---
title: "Macros - ABAP Keyword Documentation"
...
We recommend that procedures ([methods](ABENFUNCT_MODULE_SUBROUTINE_GUIDL.md "Guideline")) or expressions with appropriate operators are used instead of macros.
...
In addition, in the past macros were not just used to replace procedures, they were also used to perform recurrent declarations of structured data. Today, macros are, of course, avoided and [standalone types](ABENBOUND_INDEPENDENT_DTYPE_GUIDL.md "Guideline") are used instead.
