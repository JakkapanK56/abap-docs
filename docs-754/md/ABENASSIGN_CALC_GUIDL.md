---
title: "Assignments - ABAP Keyword Documentation"
...
to be made to variables that can also be declared inline and to [writable expressions](ABENWRITABLE_EXPRESSION_GLOSRY.md "Glossary Entry").
