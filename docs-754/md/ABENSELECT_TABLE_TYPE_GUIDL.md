---
title: "Selecting the Table Category - ABAP Keyword Documentation"
...
If you use [secondary keys](ABENSECONDARY_KEY_GUIDL.md "Guideline"), the rules mentioned here may be qualified to a certain degree, as the overall costs need to be considered in this case.
