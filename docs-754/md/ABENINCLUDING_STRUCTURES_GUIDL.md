---
title: "Including Structures - ABAP Keyword Documentation"
...
-   The statement cancels a [chained statement](ABENCHAINED_STATEMENTS_GUIDL.md "Guideline") that has been created with BEGIN OF and END OF.
