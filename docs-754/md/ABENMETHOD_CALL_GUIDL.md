---
title: "Method Calls - ABAP Keyword Documentation"
...
This form uses a parenthesis notation instead of the introductory ABAP words [CALL METHOD](ABAPCALL_METHOD_STATIC.md). A combination of CALL METHOD and parentheses is also possible.
