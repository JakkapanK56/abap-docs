---
title: "ABENCDS_1614358293_ANNO"
description: |
  ABENCDS_1614358293_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1614358293_ANNO.htm"
abapFile: "ABENCDS_1614358293_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "1614358293", "ANNO"]
---
...
This annotation shows the position of the variable generated for the user input field.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `AnalyticsDetails.variable.hierarchyBinding[ ].variableSequence`\\ **Scope** `#PARAMETER`\\ **Type** `Integer`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_analyticsdetails\_f.html