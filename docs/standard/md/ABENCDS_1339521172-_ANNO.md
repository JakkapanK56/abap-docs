---
title: "ABENCDS_1339521172-_ANNO"
description: |
  ABENCDS_1339521172-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1339521172-_ANNO.htm"
abapFile: "ABENCDS_1339521172-_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "1339521172", "ANNO"]
---
...
The PFCG-mapping defines a mapping between a PFCG-object and the access policy of an DCL. At runtime, it contains all values from the PFCG object which are assigned to an user. In this sense it behaves like a view and therefore @Consumption.derivation.pfcgMapping can be used in a similar way as @Consumption.derivation.lookupEntity.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.derivation.pfcgMapping`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `String(30)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html