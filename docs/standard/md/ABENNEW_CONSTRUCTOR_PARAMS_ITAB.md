...
description: |
  ABENNEW_CONSTRUCTOR_PARAMS_ITAB - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEW_CONSTRUCTOR_PARAMS_ITAB.htm"
...
See also the examples for the value operator [`VALUE`](ABENVALUE_CONSTRUCTOR_PARAMS_ITAB.html).
...
-   [Table filtering](ABENTABLE_FILTERING_GLOSRY.html) can be achieved more efficiently using the [filter operator](ABENFILTER_OPERATOR_GLOSRY.html)\\ [`FILTER`](ABENCONSTRUCTOR_EXPRESSION_FILTER.html).
