...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.dataPoint.criticalityCalculation.constantThresholds .acceptanceRangeHighValue` Scope `#ELEMENT` Type `DecimalFloat` Enums `-` Default `-` Text `-` MDE `X` API `REL
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_600063752-_ANNO.htm"
abapFile: "ABENCDS_600063752-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "600063752", "ANNO"]
---
...
You want specific criticality values, you can set these with the criticalityCalculation.

This annotation sets a value as a constant threshold for the criticality calculation.

No KTD found

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.dataPoint.criticalityCalculation.constantThresholds[ ].acceptanceRangeHighValue`\\ **Scope** `#ELEMENT`\\ **Type** `DecimalFloat`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html