...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Consumption.dynamicLabel.binding .replaceWith` Scope `#ELEMENT` Type `String(11)` Enums `#DIFFERENCE, #HIGH, #LOW` Default `-` Text `-` MDE `X` API `RELEASED_FOR_KEY_
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_874563402-_ANNO.htm"
abapFile: "ABENCDS_874563402-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "874563402", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.dynamicLabel.binding[ ].replaceWith`\\ **Scope** `#ELEMENT`\\ **Type** `String(11)`\\ **Enums** `#DIFFERENCE, #HIGH, #LOW`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html