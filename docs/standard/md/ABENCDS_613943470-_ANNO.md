---
title: "ABENCDS_613943470-_ANNO"
description: |
  ABENCDS_613943470-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_613943470-_ANNO.htm"
abapFile: "ABENCDS_613943470-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "613943470", "ANNO"]
---
...
This annotations represents a collection of sorting parameters.

You want to order in which way an array of values is sorted. This can either be done ascending (ASC) or descending (DESC).

This annotation defines the sorting direction of queried collections.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.presentationVariant[ ].sortOrder[ ].direction`\\ **Scope** `#ENTITY`\\ **Type** `String(4)`\\ **Enums** `#ASC, #DESC`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html