...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Consumption.dbHintsCalculatedBy` Scope `#VIEW` Type `String(255)` Enums `-` Default `-` Text `-` MDE `-` API `-` abenabap.html abencds.html abencds_annotations.html ab
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1075627299-_ANNO.htm"
abapFile: "ABENCDS_1075627299-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1075627299", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.dbHintsCalculatedBy`\\ **Scope** `#VIEW`\\ **Type** `String(255)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html