---
title: "ABENCDS_1388396290-_ANNO"
description: |
  ABENCDS_1388396290-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1388396290-_ANNO.htm"
abapFile: "ABENCDS_1388396290-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1388396290", "ANNO"]
---
...
The relative weight of the ranking functions is specified in “weight” in the interval \[0; 1\], with the default being 1.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.ranking.activeFunctions[ ].weight`\\ **Scope** `#ENTITY`, `#VIEW`\\ **Type** `Decimal(3,2)`\\ **Enums** `-`\\ **Default** `1`\\ **Text** `-`\\ **MDE** `X`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html