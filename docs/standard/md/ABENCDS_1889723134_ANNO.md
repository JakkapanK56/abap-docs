---
title: "ABENCDS_1889723134_ANNO"
description: |
  ABENCDS_1889723134_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1889723134_ANNO.htm"
abapFile: "ABENCDS_1889723134_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1889723134", "ANNO"]
---
...
This annotations contains a list of view elements (dimensions) for which totals shall be provided, even if the result is not grouped by this element. Only those elements are al-lowed which can be used in a CDS QL GROUP BY clause on the annotated view.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.presentationVariant[ ].totalBy[ ]`\\ **Scope** `#ENTITY`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html