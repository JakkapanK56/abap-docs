...
description: |
  ABENABAP_CL_IXML_XPATH - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENABAP_CL_IXML_XPATH.htm"
abapFile: "ABENABAP_CL_IXML_XPATH.html"
keywords: ["do", "if", "method", "class", "data", "internal-table", "ABENABAP", "IXML", "XPATH"]
---

The class `CL_IXML_XPATH` provides XPath evaluations only. It is a wrapper class that is independent of the XPath evaluation in the class `CL_XSLT_PROCESSOR`.
