...
description: |
  ABENSELECT_HIERARCHY_ANCS_AGG - Standard ABAP language reference documentation
library: "standard"
...
-   If the hierarchy navigator `HIERARCHY_ANCESTORS_AGGREGATE` is used, the syntax check is performed in [strict mode from ABAP release 7.77](ABENABAP_SQL_STRICTMODE_777.html).
