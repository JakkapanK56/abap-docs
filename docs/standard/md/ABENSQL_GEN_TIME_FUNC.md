...
description: |
  ABENSQL_GEN_TIME_FUNC - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENSQL_GEN_TIME_FUNC.htm"
...
All generic functions enforce the [strict mode from ABAP release 7.83](ABENABAP_SQL_STRICTMODE_783.html).
