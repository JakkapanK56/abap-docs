...
title: "No KTD found"
description: |
  This annotation contains a language-dependent text. If omitted, the @EndUserText.label of the annotated entity or view is used. You want to give an annotation a title use the title annotation. This annotation refers to a value. If the refered value is in the same view, you need to specifiy the eleme
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_2879366-_ANNO.htm"
abapFile: "ABENCDS_2879366-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "2879366", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.note.title.value`\\ **Scope** `#ENTITY`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html