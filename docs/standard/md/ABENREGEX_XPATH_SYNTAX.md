...
description: |
  ABENREGEX_XPATH_SYNTAX - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENREGEX_XPATH_SYNTAX.htm"
abapFile: "ABENREGEX_XPATH_SYNTAX.html"
keywords: ["select", "do", "while", "if", "method", "class", "data", "ABENREGEX", "XPATH", "SYNTAX"]
---
