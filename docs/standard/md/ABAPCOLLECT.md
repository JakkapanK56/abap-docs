...
title: "ABAPCOLLECT"
description: |
  ABAPCOLLECT - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPCOLLECT.htm"
...
[Do not fill standard tables with collections of lines](ABENCOLLECT_GUIDL.html)
...
-   The method `HAS_COLLECT_HASH_ADMIN` of the class `CL_ABAP_ITAB_UTILITIES` can be used in standard tables to check whether temporary hash administration of the statement `COLLECT` exists.
