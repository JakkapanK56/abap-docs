...
title: "Runtime"
description: |
  Defines an additional binding condition for the value help on the same target value help provider entity for filtering the value help result list and/or returning values from the selected value help record. Specifies the local parameter that is linked to the element or parameter in the target value
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_945672507_ANNO.htm"
abapFile: "ABENCDS_945672507_ANNO.html"
keywords: ["select", "do", "if", "data", "types", "ABENCDS", "945672507", "ANNO"]
---
...
Specifies the local parameter that is linked to the element or parameter in the target value help provider entity for the additional binding.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.valueHelpDefinition[ ].additionalBinding[ ].localParameter`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `ParameterRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html