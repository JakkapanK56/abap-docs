---
title: "You want to use the groupLabel annotation to set a human readable label for a predefined group of fields together"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.fieldGroup .groupLabel` Scope `#ELEMENT` Type `String(60)` Enums `-` Default `-` Text `X` MDE `X` API `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1947089820-_ANNO.htm"
abapFile: "ABENCDS_1947089820-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1947089820", "ANNO"]
---
...
This annotation contains language dependent text that is used as label for the field group.

You want to use the groupLabel annotation to set a human readable label for a predefined group of fields together

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.fieldGroup[ ].groupLabel`\\ **Scope** `#ELEMENT`\\ **Type** `String(60)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `X`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html