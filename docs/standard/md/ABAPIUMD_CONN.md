...
title: "ABAPIUMD_CONN"
description: |
  ABAPIUMD_CONN - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPIUMD_CONN.htm"
abapFile: "ABAPIUMD_CONN.html"
keywords: ["delete", "do", "if", "case", "catch", "class", "data", "ABAPIUMD", "CONN"]
---
...
Deletion of all data in a DDIC database table using a [service connection](ABENSERVICE_CONNECTION_GLOSRY.html) to the standard database.
...
DELETE FROM demo\_expressions CONNECTION r/3\*my\_conn. abenabap.html abenabap\_reference.html abendb\_access.html abenabap\_sql.html abenabap\_sql\_writing.html abapiumd\_options.html