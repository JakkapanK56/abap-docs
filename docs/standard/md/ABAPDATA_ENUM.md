...
title: "ABAPDATA_ENUM"
description: |
  ABAPDATA_ENUM - Standard ABAP language reference documentation
library: "standard"
...
For more information about using enumerated variables, see [enumerated objects](ABENENUMERATED_TYPES_USAGE.html).
