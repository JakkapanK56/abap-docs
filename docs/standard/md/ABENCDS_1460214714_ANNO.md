...
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1460214714_ANNO.htm"
abapFile: "ABENCDS_1460214714_ANNO.html"
keywords: ["do", "while", "if", "ABENCDS", "1460214714", "ANNO"]
---
...
Runtime: No engine usage right now. Reserved for future.

Specifies one or multiple list IDs within the term mapping dictionary mentioned before.
...
Array of String(32): Defines one or more columns of the term mapping dictionary.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Search.termMappingListId[ ]`\\ **Scope** `#ELEMENT`\\ **Type** `String(32)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_search\_f.html