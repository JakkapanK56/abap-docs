...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Consumption.defaultValue` Scope `#ELEMENT`, `#PARAMETER`, `#SIMPLE_TYPE` Type `String(1024)` Enums `-` Default `-` Text `-` MDE `X` API `RELEASED_FOR_KEY_USER_APPS, REL
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1396898918_ANNO.htm"
abapFile: "ABENCDS_1396898918_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1396898918", "ANNO"]
---
