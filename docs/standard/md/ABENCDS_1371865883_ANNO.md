---
title: "ABENCDS_1371865883_ANNO"
description: |
  ABENCDS_1371865883_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1371865883_ANNO.htm"
abapFile: "ABENCDS_1371865883_ANNO.html"
keywords: ["do", "while", "if", "data", "types", "ABENCDS", "1371865883", "ANNO"]
---
...
The entities of this set describe a data subject (an identified or identifiable natural person), e.g. Customer, Vendor

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Semantics.personalData.entitySemantics`\\ **Scope** `#ENTITY`\\ **Type** `String(30)`\\ **Enums** `#DATA_SUBJECT`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_semantics\_f.html