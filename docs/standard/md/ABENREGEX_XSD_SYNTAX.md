...
description: |
  ABENREGEX_XSD_SYNTAX - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENREGEX_XSD_SYNTAX.htm"
...
-   The test and demonstration program `DEMO_REGEX` allows XSD syntax to be tested by selecting XSD.
