...
title: "No KTD found"
description: |
  No KTD found This annotation represents the path to an element of an associated CDS view. The path is converted to an OData NavigationPropertyPath. You want to link from the header part of an object view floorplan to a target element. You need to specify UI.badge.headLine.targetElement when you use
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1837789293_ANNO.htm"
abapFile: "ABENCDS_1837789293_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1837789293", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.badge.headLine.targetElement`\\ **Scope** `#ENTITY`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html