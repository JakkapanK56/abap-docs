...
description: |
  ABAPDATA_RANGES - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPDATA_RANGES.htm"
abapFile: "ABAPDATA_RANGES.html"
keywords: ["select", "do", "if", "class", "data", "types", "ABAPDATA", "RANGES"]
---
...
-   Outside of classes, the addition [`WITH HEADER LINE`](ABAPDATA_HEADER_LINE.html) can also be used to declare an obsolete [header line](ABENHEADER_LINE_GLOSRY.html).
-   The declaration of a ranges table using the statement [`RANGES`](ABAPRANGES.html) is obsolete.
