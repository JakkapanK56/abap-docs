...
description: |
  ABENCDS_SCALAR_TYPING - Standard ABAP language reference documentation
library: "standard"
...
Specifies a reference type. Reference types allow the handling of [CDS amount fields](ABENCDS_AMOUNT_FIELD_GLOSRY.html) and [CDS quantity fields](ABENCDS_QUANTITY_GLOSRY.html). The addition is described in topic [CDS FDL - `WITH REFERENCE TYPE`](ABENCDS_WITH_REFERENCE_TYPE.html).
