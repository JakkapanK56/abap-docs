...
title: "No KTD found"
description: |
  This annotation contains a corresponding UI element should be emphasized for the end user. Such 'UI elements' might be Properties, Actions or their usage in tables or forms. The way how this emphasizing is done is a UI decision. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.h
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1549866209-_ANNO.htm"
abapFile: "ABENCDS_1549866209-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1549866209", "ANNO"]
---
...
This annotation contains a corresponding UI element should be emphasized for the end user. Such "UI elements" might be Properties, Actions or their usage in tables or forms. The way how this emphasizing is done is a UI decision.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.identification[ ].emphasized`\\ **Scope** `#ELEMENT`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html