...
description: |
  ABENNEWS-914-AMDP - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-914-AMDP.htm"
...
In [client-safe](ABENAMDP_CLIENT_SAFETY.html) AMDP methods, only objects of the [ABAP database schema](ABENABAP_DB_SCHEMA_GLOSRY.html) can be accessed that can be controlled by the `USING` list. Especially objects of database schemas of the namespace `/1BCAMDP/` cannot be accessed.
