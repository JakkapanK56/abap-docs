...
title: "No KTD found"
description: |
  This annotation specifies what hierarchy type is used different values determine which CDS elements are required or available. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.facet .type` Scope `#ELEMENT` Type `String(40)` Enums `#ADDR
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_824350749_ANNO.htm"
abapFile: "ABENCDS_824350749_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "824350749", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.facet[ ].type`\\ **Scope** `#ELEMENT`\\ **Type** `String(40)`\\ **Enums** `#ADDRESS_REFERENCE, #BADGE_REFERENCE, #CHART_REFERENCE, #COLLECTION, #CONTACT_REFERENCE, #DATAPOINT_REFERENCE, #FIELDGROUP_REFERENCE, #HEADERINFO_REFERENCE, #IDENTIFICATION_REFERENCE, #LINEITEM_REFERENCE, #NOTE_REFERENCE, #PRESENTATIONVARIANT_REFERENCE, #SELECTIONPRESENTATIONVARIANT_REFERENCE, #STATUSINFO_REFERENCE, #URL_REFERENCE`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html