---
title: "ABENCONV_TYPE_INFERENCE_ABEXA"
description: |
  ABENCONV_TYPE_INFERENCE_ABEXA - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCONV_TYPE_INFERENCE_ABEXA.htm"
...
-   In the second call, the type `i` does not match the generic type and the type `c` with the predefined [output length](ABENWRITE_OUTPUT_LENGTH.html) 11 of `i` is used.
