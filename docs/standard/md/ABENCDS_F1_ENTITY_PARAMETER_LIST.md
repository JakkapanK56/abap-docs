...
description: |
  ABENCDS_F1_ENTITY_PARAMETER_LIST - Standard ABAP language reference documentation
library: "standard"
...
The class `CL_DEMO_CDS_ABSTRCT_ENTTY_PARA` shows that the parameter annotations of the CDS abstract entity can be [evaluated](ABENCDS_ANNOTATIONS_ANALYSIS.html) using the class `CL_DD_DDL_ANNOTATION_SERVICE`.
