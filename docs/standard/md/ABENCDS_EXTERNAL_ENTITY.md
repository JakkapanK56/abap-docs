...
-   In ABAP, the CDS entity can be used as a data type and in ABAP SQL read statements. The addition [`PROVIDED BY`](ABAPSELECT_DATA_SOURCE.html) for specifying a [logical external schema](ABENCDS_LOGICAL_SCHEMA_GLOSRY.html) at runtime is mandatory for dynamic external entities.
-   Dynamic external entities cannot be used as data source for other CDS entities.
...
-   \\ [CDS External Entities](https://help.sap.com/docs/ABAP_Cloud/aaae421481034feab3e71dd9e0f643bf/a35d61383b7042faac162b6c16d055a3?version=sap_cross_product_abap) -ABAP Data Models guide (SAP Help Portal)
