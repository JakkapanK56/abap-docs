...
title: "ABENCDS_BDEF"
description: |
  ABENCDS_BDEF - Standard ABAP language reference documentation
library: "standard"
...
RAP behavior definitions are connected to the [Switch Framework](ABENSWITCH_FRAMEWORK_GLOSRY.html) whenever they are defined in a [package](ABENPACKAGE_GLOSRY.html) that is assigned a [switch](ABENSWITCH_GLOSRY.html).
