---
title: "This annotation contains the url to an icon image"
description: |
  You want to set an icon, you will need to set an URL to the icon image. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.fieldGroup .iconUrl` Scope `#ELEMENT` Type `String(1024)` Enums `-` Default `-` Text `-` MDE `X`
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_2098531768-_ANNO.htm"
abapFile: "ABENCDS_2098531768-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "2098531768", "ANNO"]
---
