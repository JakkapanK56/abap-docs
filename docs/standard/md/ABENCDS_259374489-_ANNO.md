...
title: "No KTD found"
description: |
  This annotation specifies the target value of the data point. The value set is a constant element. You want to set a value as a target for a data point. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.kpi .dataPoint.targetValue` Scope `#ELEMENT`
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_259374489-_ANNO.htm"
abapFile: "ABENCDS_259374489-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "259374489", "ANNO"]
---
...
This annotation specifies the target value of the data point. The value set is a constant element.

You want to set a value as a target for a data point.
