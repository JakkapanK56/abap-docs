---
title: "ABENNEWS-751-TRANSFORMATIONS"
description: |
  ABENNEWS-751-TRANSFORMATIONS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-751-TRANSFORMATIONS.htm"
abapFile: "ABENNEWS-751-TRANSFORMATIONS.html"
keywords: ["do", "if", "data", "types", "ABENNEWS", "751", "TRANSFORMATIONS"]
---
...
The following new formats can be specified in parentheses after [`format`](ABENST_OPTION_FORMAT.html) in the [`option`](ABENST_OPTION.html) attribute of the ST command [`tt:value`](ABENST_TT_VALUE_ELEMENTARY.html):

Other enhancements:

[`decimals`](ABENST_OPTION_FORMAT.html) can now be specified in the attribute [`option`](ABENST_OPTION.html) of the ST command [`tt:value`](ABENST_TT_VALUE_ELEMENTARY.html), where it defines the number of decimal places of numeric types.

[`regime(num|char|bin)`](ABENST_OPTION_FORMAT.html) can now be specified in the attribute [`option`](ABENST_OPTION.html) of the ST command [`tt:value`](ABENST_TT_VALUE_ELEMENTARY.html), where it can be used to force numeric, character-like, or byte-like handling.

[`noError`](ABENST_OPTION_FORMAT.html) now can be specified in the attribute [`option`](ABENST_OPTION.html) of the ST command [`tt:value`](ABENST_TT_VALUE_ELEMENTARY.html), where it prevents exceptions in the formattings `language`, `currCode`, and `unitCode`. These formattings evaluate entries in database tables.
