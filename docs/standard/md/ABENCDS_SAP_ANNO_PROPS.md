...
description: |
  ABENCDS_SAP_ANNO_PROPS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_SAP_ANNO_PROPS.htm"
...
-   **Scope**
-   Scopes where the annotation can be specified. The scopes are shown by the enumeration symbols that are specified in the corresponding annotation definition for the [`@Scope`](ABENCDS_1049724201-_ANNO.html) annotation. The topic [Scopes for Annotations](ABENCDS_ANNOTATIONS_SCOPES.html) maps these to source code positions.
-   **Type**
-   [Type](ABENCDS_F1_DEFINE_ANNOTATION_TYPE.html) of the [annotation value](ABENANNOTATION_VALUE_GLOSRY.html).
-   **Enums**
-   [Enumeration symbols](ABENCDS_F1_DEFINE_ANNOTATION_TYPE.html).
-   **Default**
