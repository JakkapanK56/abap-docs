...
description: |
  ABENJSON_OVIEW - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENJSON_OVIEW.htm"
...
-   The class `CL_DEMO_JSON_SYNTAX_CHECK` checks the syntax of freely entered JSON data.
