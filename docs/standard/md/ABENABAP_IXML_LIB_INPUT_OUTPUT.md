---
title: "ABENABAP_IXML_LIB_INPUT_OUTPUT"
description: |
  ABENABAP_IXML_LIB_INPUT_OUTPUT - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENABAP_IXML_LIB_INPUT_OUTPUT.htm"
abapFile: "ABENABAP_IXML_LIB_INPUT_OUTPUT.html"
...
The XML result of a transformation of an ABAP data object to the [asXML](ABENABAP_XSLT_ASXML.html) format is used to create an iXML input stream. This stream is then transformed back again.
