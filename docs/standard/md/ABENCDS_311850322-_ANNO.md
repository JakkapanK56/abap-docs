...
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_311850322-_ANNO.htm"
abapFile: "ABENCDS_311850322-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "311850322", "ANNO"]
---
...
Denotes the external name of CDS elements, parameters or associations for the properties of an abstract entity.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `OData.property.name`\\ **Scope** `#ELEMENT`\\ **Type** `String(128)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_odata\_f.html