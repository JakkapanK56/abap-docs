...
title: "No KTD found"
description: |
  This annotation refers to the name of an action on an semantic object. The object is used from @Consumption.semanticObject or derived via an association from the defining view. ) Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.identification .semanticOb
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1283009334_ANNO.htm"
abapFile: "ABENCDS_1283009334_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1283009334", "ANNO"]
---
...
This annotation refers to the name of an action on an semantic object.

The object is used from @Consumption.semanticObject or derived via an association from the defining view.

)

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.identification[ ].semanticObject`\\ **Scope** `#ELEMENT`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html