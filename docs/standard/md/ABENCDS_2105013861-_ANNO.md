...
title: "No KTD found"
description: |
  This annotation represents a path to an element containing the URL of an image representing the entity instance. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.badge.imageUrl` Scope `#ENTITY` Type `ElementRef` Enums `-` Default `-
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_2105013861-_ANNO.htm"
abapFile: "ABENCDS_2105013861-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "2105013861", "ANNO"]
---
...
This annotation represents a path to an element containing the URL of an image representing the entity instance.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.badge.imageUrl`\\ **Scope** `#ENTITY`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html