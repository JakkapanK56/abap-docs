---
title: "ABENCDS_557446502-_ANNO"
description: |
  ABENCDS_557446502-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_557446502-_ANNO.htm"
abapFile: "ABENCDS_557446502-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "557446502", "ANNO"]
---
...
This annotation can be used as an alternative to dataPoint.trend. The trend annotation can be calculated based on the values given in the trendCalculation annotation.

You want to specify your own trend, trendCalculation can be used.

This annotation expresses if the following values are absolute or relative differences.

For example, your reference value is 10, and your current value is 12. The absolute difference of these two values is 2, and the relative difference of these two values is 1.2

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.dataPoint.trendCalculation.isRelativeDifference`\\ **Scope** `#ELEMENT`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html