...
description: |
  ABENNEWS-750-TYPES - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-750-TYPES.htm"
abapFile: "ABENNEWS-750-TYPES.html"
keywords: ["do", "if", "class", "data", "types", "ABENNEWS", "750", "TYPES"]
---
...
A CDS can be assigned as a [replacement object](ABENDDIC_REPLACEMENT_OBJECTS.html) to a transparent database table or a classic database view. In ABAP SQL reads, the replacement object is then accessed instead of the original object.
