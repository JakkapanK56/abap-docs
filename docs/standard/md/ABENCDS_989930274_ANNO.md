---
title: "ABENCDS_989930274_ANNO"
description: |
  ABENCDS_989930274_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_989930274_ANNO.htm"
abapFile: "ABENCDS_989930274_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "989930274", "ANNO"]
---
...
This annotation describes the business period of evaluation.

Typical patterns are calendar dates or fiscal dates, for example "Oct 2012".

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.dataPoint.referencePeriod.description`\\ **Scope** `#ELEMENT`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `X`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html