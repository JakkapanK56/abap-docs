...
description: |
  ABAPTYPES_STRUC - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPTYPES_STRUC.htm"
abapFile: "ABAPTYPES_STRUC.html"
keywords: ["select", "do", "if", "types", "ABAPTYPES", "STRUC"]
---

[Short Reference](ABAPTYPES_BEGIN_OF_SHORTREF.html)
...
The statement [`INCLUDE`](ABAPINCLUDE_PROG.html) defines components of the structured type `struc_type` by copying the components of a differently structured type or an existing structure at the same level.
