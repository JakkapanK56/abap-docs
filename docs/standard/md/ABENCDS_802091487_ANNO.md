...
title: "Single value"
description: |
  Interval is a special case of a Range with “sign = including” and “option = BT”. A Range is a complete (ABAP like) SELECT-option including sign (including/excluding) and operator (EQ, CP, BT...). Hierarchy node (means everything under the node) Kind Framework-specific annotation(ABENFRMWRK_ANN
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_802091487_ANNO.htm"
abapFile: "ABENCDS_802091487_ANNO.html"
keywords: ["select", "do", "if", "case", "data", "ABENCDS", "802091487", "ANNO"]
---
...
Determines how values can be entered.
...
Hierarchy node (means everything under the node)

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `AnalyticsDetails.variable.selectionType`\\ **Scope** `#PARAMETER`\\ **Type** `String(20)`\\ **Enums** `#HIERARCHY_NODE, #INTERVAL, #RANGE, #SINGLE`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_analyticsdetails\_f.html