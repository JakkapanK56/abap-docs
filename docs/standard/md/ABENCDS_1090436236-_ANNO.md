...
title: "No KTD found"
description: |
  This annotation expresses the importance of DataFields or other annotations. Could be used e.g. in dynamic rendering approaches with responsive design patterns. You defined a table with several columns. The columns that need to be displayed always, get importance HIGH. This ensures that these column
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1090436236-_ANNO.htm"
abapFile: "ABENCDS_1090436236-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1090436236", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.facet[ ].importance`\\ **Scope** `#ELEMENT`\\ **Type** `String(6)`\\ **Enums** `#HIGH, #LOW, #MEDIUM`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html