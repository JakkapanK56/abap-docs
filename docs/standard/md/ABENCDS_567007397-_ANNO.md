...
title: "No KTD found"
description: |
  No KTD found This annotation contains the URL to an icon image. You want to add an icon into the @UI.badge.headline. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.badge.headLine.iconUrl` Scope `#ENTITY` Type `String(1024)` Enums `-`
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_567007397-_ANNO.htm"
abapFile: "ABENCDS_567007397-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "567007397", "ANNO"]
---
