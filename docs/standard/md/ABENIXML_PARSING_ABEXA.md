---
title: "ABENIXML_PARSING_ABEXA"
description: |
  ABENIXML_PARSING_ABEXA - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENIXML_PARSING_ABEXA.htm"
abapFile: "ABENIXML_PARSING_ABEXA.html"
...
An [iterator](ABENABAP_IXML_LIB_DOM_ITERAT_READ.html) is used to access the nodes. Each element is [checked](ABENABAP_IXML_LIB_DOM_DIRECT_READ.html) to see whether it has attributes. Existing attributes are then read.
