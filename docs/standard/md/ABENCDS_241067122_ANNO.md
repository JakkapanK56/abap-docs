---
title: "ABENCDS_241067122_ANNO"
description: |
  ABENCDS_241067122_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_241067122_ANNO.htm"
abapFile: "ABENCDS_241067122_ANNO.html"
keywords: ["do", "if", "case", "data", "types", "ABENCDS", "241067122", "ANNO"]
---
...
This annotation defines the representation type of the visualization annotation.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.presentationVariant[ ].visualizations[ ].type`\\ **Scope** `#ENTITY`\\ **Type** `String(40)`\\ **Enums** `#AS_CHART, #AS_DATAPOINT, #AS_LINEITEM`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html