---
title: "This annotation defines the preferred visualization of a data point"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.dataPoint.visualization` Scope `#ELEMENT` Type `String(12)` Enums `#BULLET_CHART, #DONUT, #NUMBER, #PROGRESS, #RATING` Default `-` Text `-` MDE `X` API `RELEASED_FOR
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1590835810-_ANNO.htm"
abapFile: "ABENCDS_1590835810-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1590835810", "ANNO"]
---
...
This annotation defines the preferred visualization of a data point

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.dataPoint.visualization`\\ **Scope** `#ELEMENT`\\ **Type** `String(12)`\\ **Enums** `#BULLET_CHART, #DONUT, #NUMBER, #PROGRESS, #RATING`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html