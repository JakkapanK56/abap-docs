...
title: "No KTD found"
description: |
  This annotation defines the manner in which a dimension is used within a chart.This is configured differently for each chart type. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.chart .dimensionAttributes .role` Scope `#ENTITY` Type `Stri
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_921303495-_ANNO.htm"
abapFile: "ABENCDS_921303495-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "921303495", "ANNO"]
---
...
This annotation defines the manner in which a dimension is used within a chart.This is configured differently for each chart type.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.chart[ ].dimensionAttributes[ ].role`\\ **Scope** `#ENTITY`\\ **Type** `String(10)`\\ **Enums** `#CATEGORY, #CATEGORY2, #SERIES`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html