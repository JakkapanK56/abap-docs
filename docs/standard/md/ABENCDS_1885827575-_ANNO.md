---
title: "ABENCDS_1885827575-_ANNO"
description: |
  ABENCDS_1885827575-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1885827575-_ANNO.htm"
abapFile: "ABENCDS_1885827575-_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "1885827575", "ANNO"]
---
...
Sets the offset relative to the first day of a period, if derivationType is set to #OFFSET

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `AnalyticsDetails.query.temporalJoin.offsetOfDays`\\ **Scope** `#ELEMENT`\\ **Type** `Integer`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_analyticsdetails\_f.html