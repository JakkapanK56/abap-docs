...
description: |
  ABENBDL_PRAGMA - Standard ABAP language reference documentation
library: "standard"
...
Pragmas can be used to hide [syntax check](ABENSYNTAX_CHECK_GLOSRY.html) warnings from the [ABAP Compiler](ABENABAP_COMPILER_GLOSRY.html) .
