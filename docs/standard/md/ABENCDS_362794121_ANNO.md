---
title: "ABENCDS_362794121_ANNO"
description: |
  ABENCDS_362794121_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_362794121_ANNO.htm"
abapFile: "ABENCDS_362794121_ANNO.html"
keywords: ["update", "do", "while", "if", "case", "data", "types", "ABENCDS", "362794121", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Semantics.largeObject.contentDispositionPreference`\\ **Scope** `#ELEMENT`\\ **Type** `String(30)`\\ **Enums** `#ATTACHMENT, #INLINE`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_semantics\_f.html