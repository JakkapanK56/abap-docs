...
description: |
  ABENABAP_SQL_HOST_EXPRESSIONS - Standard ABAP language reference documentation
library: "standard"
...
-   When host expressions are specified, the syntax check is performed in a [strict mode](ABENABAP_SQL_STRICTMODE_760.html), which handles the statement more strictly than the regular syntax check.
