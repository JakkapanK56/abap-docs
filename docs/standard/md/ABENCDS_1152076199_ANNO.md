---
title: "ABENCDS_1152076199_ANNO"
description: |
  ABENCDS_1152076199_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1152076199_ANNO.htm"
abapFile: "ABENCDS_1152076199_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1152076199", "ANNO"]
---
...
This annotation contains a list of view elements (dimensions) which should be grouped on the UI. Only those elements are allowed which can be used in a CDS QL GROUP BY clause on the annotated view. If total is specified, then totals will be provided on the grouping headers / aggregation levels in which the element occurs.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.presentationVariant[ ].groupBy[ ]`\\ **Scope** `#ENTITY`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html