...
description: |
  ABENCDS_EXCEPT_V2 - Standard ABAP language reference documentation
library: "standard"
...
The class `CL_DEMO_CDS_EXCEPT_NESTING` first fills the underlying database tables and then accesses the view using [`SELECT`](ABAPSELECT.html). The result set consists of 9 rows.
