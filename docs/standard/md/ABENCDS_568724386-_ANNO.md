...
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_568724386-_ANNO.htm"
abapFile: "ABENCDS_568724386-_ANNO.html"
keywords: ["do", "if", "ABENCDS", "568724386", "ANNO"]
---
...
No engine usage right now. Reserved for future.

Specifies the table that holds the term mappings (synonyms) to be considered in the context of a search on this view.

String(128): Defines the term mapping dictionary, e.g. a table or entity.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Search.termMappingDictionary`\\ **Scope** `#ELEMENT`\\ **Type** `String(128)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_search\_f.html