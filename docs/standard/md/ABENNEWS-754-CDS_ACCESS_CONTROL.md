---
title: "ABENNEWS-754-CDS_ACCESS_CONTROL"
description: |
  ABENNEWS-754-CDS_ACCESS_CONTROL - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-754-CDS_ACCESS_CONTROL.htm"
abapFile: "ABENNEWS-754-CDS_ACCESS_CONTROL.html"
keywords: ["select", "if", "ABENNEWS", "754", "CDS", "ACCESS", "CONTROL"]
---
...
[6. Different `REPLACING` Operators](#ABAP_MODIFICATION_6@4@) 

[7. `REPLACING` Operator `ELEMENT ... WITH`](#ABAP_MODIFICATION_7@4@)

[8\. Definition of a Generic Aspect](#ABAP_MODIFICATION_8@4@)

[9\. Access Control for ABAP CDS Hierarchies](#ABAP_MODIFICATION_9@4@)

[10\. DCL Restrictions for CDS Transactional Queries](#ABAP_MODIFICATION_10@4@)

[11. `VOID`](#ABAP_MODIFICATION_11@4@)

[12. `CONSTRAINT ID`](#ABAP_MODIFICATION_12@4@)
...
The optional addition [`REPLACING`](ABENCDS_F1_COND_INHERIT.html) of `INHERITING CONDITIONS` can be used to modify the inherited conditions.
