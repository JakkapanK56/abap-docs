...
description: |
  ABENCHAR_DATE_TIME_FIELDS_ACCESS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCHAR_DATE_TIME_FIELDS_ACCESS.htm"
...
-   In output formatting using [string templates](ABENSTRING_TEMPLATES.html) or the statement [`WRITE [TO]`](ABAPWRITE_TO.html)
