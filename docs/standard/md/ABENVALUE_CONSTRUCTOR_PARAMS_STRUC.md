...
description: |
  ABENVALUE_CONSTRUCTOR_PARAMS_STRUC - Standard ABAP language reference documentation
library: "standard"
...
See also the examples for the instance operator [`NEW`](ABENNEW_CONSTRUCTOR_PARAMS_STRUCT.html).
