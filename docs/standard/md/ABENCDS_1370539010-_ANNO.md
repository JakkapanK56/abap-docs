...
title: "No KTD found"
description: |
  This annotation sets the relative position of the Facet for the annotated CDS element in the collection of Facet on entity-level. Must be specified to allow interspersing extension elements via extend views. You want to set the order, in which elements should be positioned in the UI. The value is se
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1370539010-_ANNO.htm"
abapFile: "ABENCDS_1370539010-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1370539010", "ANNO"]
---
...
This annotation sets the relative position of the Facet for the annotated CDS element in the collection of Facet on entity-level. Must be specified to allow interspersing extension elements via extend views.

You want to set the order, in which elements should be positioned in the UI. The value is set in 10 steps.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.facet[ ].position`\\ **Scope** `#ELEMENT`\\ **Type** `DecimalFloat`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html