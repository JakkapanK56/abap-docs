...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Semantics.timeZoneReference` Scope `#ELEMENT`, `#PARAMETER` Type `ElementRef` Enums `-` Default `-` Text `-` MDE `-` API `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_C
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1144633199-_ANNO.htm"
abapFile: "ABENCDS_1144633199-_ANNO.html"
keywords: ["do", "while", "if", "data", "types", "ABENCDS", "1144633199", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Semantics.timeZoneReference`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_semantics\_f.html