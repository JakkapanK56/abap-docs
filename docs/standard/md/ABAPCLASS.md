...
title: "ABAPCLASS"
description: |
  ABAPCLASS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPCLASS.htm"
...
-   `CLASS` and `ENDCLASS` cannot be listed within classes, procedures, and processing blocks that are implemented internally as a procedure, that is, event blocks for [`GET`](ABAPGET-.html) and [`AT SELECTION-SCREEN`](ABAPAT_SELECTION-SCREEN.html).
...
-   The obsolete variant [`CLASS ... DEFINITION LOAD`](ABAPCLASS_INTERFACE_LOAD.html) was formerly used to load classes explicitly.
