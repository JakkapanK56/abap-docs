...
title: "ABENABAP"
description: |
  ABENABAP - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENABAP.htm"
abapFile: "ABENABAP.html"
keywords: ["do", "if", "case", "class", "data", "types", "ABENABAP"]
---

This documentation describes the syntax and semantics of the keywords of programming languages provided by SAP on an [Application Server ABAP](ABENAS_ABAP_GLOSRY.html) (AS ABAP) of an [ABAP system](ABENABAP_SYSTEM_GLOSRY.html) for [classic ABAP](ABENCLASSIC_ABAP_GLOSRY.html). It also provides an introductory description of the environment of these languages and of language-related frameworks and the corresponding system classes.

The language version [Standard ABAP](ABENSTANDARD_ABAP_GLOSRY.html) and the frameworks for [classic ABAP](ABENCLASSIC_ABAP_GLOSRY.html) cover all elements of the [ABAP technology](ABENABAP_TECHNO_GLOSRY.html).
...
-   [SAP GUI User Dialogs Glossary](ABENSAP_GUI_GLOSSARY.html)