...
description: |
  ABENC0_CONSUMER_RULES_DDIC - Standard ABAP language reference documentation
library: "standard"
...
-   All extension field names must start with the correct [namespace prefix](ABENNAMES_REPOS_OBJ_GUIDL.html).
...
-   C0 released structures must not be used as [include structure](ABENDDIC_INCLUDE_STRUCTURE.html) in any [DDIC view](ABENDDIC_VIEW_GLOSRY.html).
