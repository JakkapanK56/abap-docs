...
title: "No KTD found"
description: |
  Label is an optional element containing a language-dependent text if omitted, the label of the annotated element or the label of the element referenced via value is used. You want to create human readable labels for data fields so you add a label annotation for @UI.facet. Kind Framework-specifi
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_799955090_ANNO.htm"
abapFile: "ABENCDS_799955090_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "799955090", "ANNO"]
---
...
Label is an optional element containing a language-dependent text

if omitted, the label of the annotated element or the label of the element referenced via value is used.

You want to create human readable labels for data fields so you add a label annotation for @UI.facet.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.facet[ ].label`\\ **Scope** `#ELEMENT`\\ **Type** `String(60)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `X`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html