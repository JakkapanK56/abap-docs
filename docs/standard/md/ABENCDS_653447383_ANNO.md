...
title: "No KTD found"
description: |
  This annotation allows to display or hide a datapoint depending on instance data. The CDS annotation element hidden is translated into an OData annotation on a Record expression. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.kpi .dataPoint.hidden`
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_653447383_ANNO.htm"
abapFile: "ABENCDS_653447383_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "653447383", "ANNO"]
---
...
This annotation allows to display or hide a datapoint depending on instance data.

The CDS annotation element hidden is translated into an OData annotation on a Record expression.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.kpi[ ].dataPoint.hidden`\\ **Scope** `#ELEMENT`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html