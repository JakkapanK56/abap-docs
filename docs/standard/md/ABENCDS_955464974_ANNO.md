---
title: "ABENCDS_955464974_ANNO"
description: |
  ABENCDS_955464974_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_955464974_ANNO.htm"
abapFile: "ABENCDS_955464974_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "955464974", "ANNO"]
---
...
This annotation allows to recognize View/Entity elements whose values are semantically dependent on the values of other elements and can only be understood in their context. Whenever such elements are used for querying grouped data, the context-providing elements should also be included in the query's group-by expression.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.groupWithElement`\\ **Scope** `#ELEMENT`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html