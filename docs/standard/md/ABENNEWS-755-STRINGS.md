...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-755-STRINGS.htm"
...
-   addition [`CURRENCY`](ABAPWRITE_TO_OPTIONS.html) of the [`WRITE TO`](ABAPWRITE_TO.html) and [`WRITE`](ABAPWRITE-.html) statements
