---
title: "ABENCDS_1501489672_ANNO"
description: |
  ABENCDS_1501489672_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1501489672_ANNO.htm"
abapFile: "ABENCDS_1501489672_ANNO.html"
keywords: ["do", "if", "data", "types", "ABENCDS", "1501489672", "ANNO"]
---
...
The presentation variant indicates how the value help result should be displayed.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.valueHelpDefinition[ ].presentationVariantQualifier`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html