---
title: "ABENCDS_334487027_ANNO"
description: |
  ABENCDS_334487027_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_334487027_ANNO.htm"
abapFile: "ABENCDS_334487027_ANNO.html"
keywords: ["do", "while", "if", "data", "types", "ABENCDS", "334487027", "ANNO"]
---
...
This annotation is the first annotation in a vocabulary specific to the *European General Data Protection Regulation (GDPR).*

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Semantics.personalData.isPotentiallySensitive`\\ **Scope** `#ELEMENT`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_semantics\_f.html