---
title: "ABENABAP_IXML_LIB_DOM_ACCESS"
description: |
  ABENABAP_IXML_LIB_DOM_ACCESS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENABAP_IXML_LIB_DOM_ACCESS.htm"
abapFile: "ABENABAP_IXML_LIB_DOM_ACCESS.html"
keywords: ["do", "if", "class", "data", "ABENABAP", "IXML", "LIB", "DOM", "ACCESS"]
---

[DOM](ABENDOM_GLOSRY.html) describes a tree-like representation, implemented using instances of classes, of a complete XML document in the memory. At the same time, each component of the XML file is created by a separate object. The associated [interfaces](ABENABAP_IXML_LIB_DOM.html) of the iXML Library can be used to access an XML document in DOM format.

[DOM Representation](ABENIXML_DOM_ABEXA.html)

-   [Reads performed on DOM](ABENABAP_IXML_LIB_DOM_ACCESS_READ.html)
-   [Writes performed on DOM](ABENABAP_IXML_LIB_DOM_ACCESS_READ.html)
