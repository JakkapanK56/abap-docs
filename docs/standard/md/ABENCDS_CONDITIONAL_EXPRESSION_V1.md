...
-   Comparisons with [comparison operators](ABENCDS_COND_EXPR_COMP_V1.html)
-   Interval comparisons using [`BETWEEN`](ABENCDS_COND_EXPR_BETW_V1.html)
-   Pattern comparisons using [`LIKE`](ABENCDS_COND_EXPR_LIKE_V1.html)
-   Checks on the [null value](ABENNULL_VALUE_GLOSRY.html) using [`IS NULL`](ABENCDS_COND_EXPR_NULL_V1.html)
-   Checks on the [initial value](ABENINITIAL_VALUE_GLOSRY.html) using [`IS INITIAL`](ABENCDS_COND_EXPR_INITIAL_V1.html)
