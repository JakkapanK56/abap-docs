...
title: "No KTD found"
description: |
  A fiscal period is covered by financial reports, for example, an annual report covers a fiscal period of one year, but a quarterly report includes accounting data for three months. The value of the annotated field encodes a fiscal week as a string following the pattern WW consisting of two digits. T
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1976141743-_ANNO.htm"
abapFile: "ABENCDS_1976141743-_ANNO.html"
keywords: ["do", "while", "if", "data", "types", "ABENCDS", "1976141743", "ANNO"]
---
...
The value of the annotated field encodes a fiscal week as a string following the pattern WW consisting of two digits.

The string matches the regex pattern 0\[1-9\]|\[1-4\]\[0-9\]|5\[2-3\]

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Semantics.fiscal.week`\\ **Scope** `#ELEMENT`, `#PARAMETER`, `#SIMPLE_TYPE`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_semantics\_f.html