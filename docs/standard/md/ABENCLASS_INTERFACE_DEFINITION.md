...
description: |
  ABENCLASS_INTERFACE_DEFINITION - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCLASS_INTERFACE_DEFINITION.htm"
...
Global classes and interfaces can be edited in the [Class Builder](ABENCLASS_BUILDER_GLOSRY.html), either in form-based or source code-based mode. In form-based mode, the Class Builder generates the corresponding source code that can be accessed directly in source-code based mode. The [ABAP development tools for Eclipse (ADT)](ABENADT_GLOSRY.html) only offer the source code-based mode.
