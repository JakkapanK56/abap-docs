...
title: "ABENBDL"
description: |
  ABENBDL - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENBDL.htm"
abapFile: "ABENBDL.html"
keywords: ["do", "if", "types", "ABENBDL"]
---
...
The BDL source code has its own editor in [ADT](ABENADT_GLOSRY.html), which is documented there. BDL source code can also be displayed in the [Repository Browser](ABENREPOSITORY_BROWSER_GLOSRY.html) in [ABAP Workbench](ABENABAP_WORKBENCH_GLOSRY.html).
