---
title: "ABENCDS_351463783-_ANNO"
description: |
  ABENCDS_351463783-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_351463783-_ANNO.htm"
abapFile: "ABENCDS_351463783-_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "351463783", "ANNO"]
---
...
Entity which is used to read the result to fill the parameter value or the element filter.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.derivation.lookupEntity`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `EntityRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html