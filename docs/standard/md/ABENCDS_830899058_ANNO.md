---
title: "ABENCDS_830899058_ANNO"
description: |
  ABENCDS_830899058_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_830899058_ANNO.htm"
abapFile: "ABENCDS_830899058_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "830899058", "ANNO"]
---
...
This annotation contains a language-dependent text. If omitted, the @EndUserText.quickInfo of the annotated entity or view is used.

You want to give an annotation a descriptive text, you can use the description annotation.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.chart[ ].description`\\ **Scope** `#ENTITY`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `X`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html