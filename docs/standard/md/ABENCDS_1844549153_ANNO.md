---
title: "ABENCDS_1844549153_ANNO"
description: |
  ABENCDS_1844549153_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1844549153_ANNO.htm"
abapFile: "ABENCDS_1844549153_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1844549153", "ANNO"]
---
...
This annotation indicates whether a grand total shall be shown (for the measures in total).

You want to display the grand total of meassures, this annotation can be used.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.presentationVariant[ ].includeGrandTotal`\\ **Scope** `#ENTITY`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html