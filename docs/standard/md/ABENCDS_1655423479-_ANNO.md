...
description: |
  The release contract `C0` permits adding of custom fields at dedicated extension points using the key user app Custom Fields and Logic. Defines allowed changes to the usage of the annotation in a CDS entity with release contract `C0` after its release. Defines whether the annotation values may b
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1655423479-_ANNO.htm"
abapFile: "ABENCDS_1655423479-_ANNO.html"
keywords: ["update", "do", "if", "data", "ABENCDS", "1655423479", "ANNO"]
---
...
Defines whether the annotation values may be changed in a CDS entity with release contract `C0` after its release.
