...
description: |
  ABAPCLASS-METHODS_EVENT_HANDLER - Standard ABAP language reference documentation
library: "standard"
...
The class `dialog_box` defines a static event handler `close_box` for the event that is raised when the user wants to close a [Control Frameworks](ABENCONTROL_FRAMEWORK_GLOSRY.html) (CFW) dialog box.
