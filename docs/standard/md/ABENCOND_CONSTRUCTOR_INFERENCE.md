...
description: |
  ABENCOND_CONSTRUCTOR_INFERENCE - Standard ABAP language reference documentation
library: "standard"
...
The operator `COND` generates a result of type `string` in this case. The generic parameter `p` has this type during the execution of the method, which is displayed by the value *g* returned by [`DESCRIBE FIELD`](ABAPDESCRIBE_FIELD.html). The method call leads to a corresponding syntax warning.
