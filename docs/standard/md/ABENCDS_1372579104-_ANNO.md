...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1372579104-_ANNO.htm"
abapFile: "ABENCDS_1372579104-_ANNO.html"
keywords: ["do", "if", "data", "types", "ABENCDS", "1372579104", "ANNO"]
---
...
This annotation defines whether criticality is represented by an icon or not.

You want to display the criticality of an element as an icon or as text, you can use the criticalityRepresantion Annotation.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.badge.mainInfo.criticalityRepresentation`\\ **Scope** `#ENTITY`\\ **Type** `String(12)`\\ **Enums** `#WITHOUT_ICON, #WITH_ICON`\\ **Default** `#WITHOUT_ICON`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html