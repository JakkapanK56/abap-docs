...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_374889579_ANNO.htm"
abapFile: "ABENCDS_374889579_ANNO.html"
keywords: ["do", "if", "data", "types", "ABENCDS", "374889579", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.badge.secondaryInfo.type`\\ **Scope** `#ENTITY`\\ **Type** `String(40)`\\ **Enums** `#STANDARD, #WITH_INTENT_BASED_NAVIGATION, #WITH_NAVIGATION_PATH, #WITH_URL`\\ **Default** `#STANDARD`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html