...
title: "No KTD found"
description: |
  This annotation contains the name, email, telephone, address or organization of the person resposible for the UI.datapoint specifications. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.kpi .dataPoint.responsible` Scope `#ELEMENT` Type `Ele
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_736589333_ANNO.htm"
abapFile: "ABENCDS_736589333_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "736589333", "ANNO"]
---
