...
title: "Runtime"
description: |
  Uniquely identifies alternative values for an annotation. Omission means that the OData term is applied without explicit qualifier. If more than one value help is defined for one element, a qualifier must be used. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_431826238-_ANNO.htm"
abapFile: "ABENCDS_431826238-_ANNO.html"
keywords: ["do", "if", "data", "types", "ABENCDS", "431826238", "ANNO"]
---
...
Uniquely identifies alternative values for an annotation.

Omission means that the OData term is applied without explicit qualifier.

If more than one value help is defined for one element, a qualifier must be used.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.valueHelpDefinition[ ].qualifier`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html