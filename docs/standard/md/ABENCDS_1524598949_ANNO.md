---
title: "ABENCDS_1524598949_ANNO"
description: |
  ABENCDS_1524598949_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1524598949_ANNO.htm"
abapFile: "ABENCDS_1524598949_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "1524598949", "ANNO"]
---
...
See "resultAggregation".

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.derivation.resultAggregationHigh`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `String(30)`\\ **Enums** `#AVG, #COUNT_DISTINCT, #MAX, #MIN, #SUM`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html