...
title: "No KTD found"
description: |
  No KTD found Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.connectedFields .semanticObjectBinding .element` Scope `#ELEMENT` Type `String(40)` Enums `-` Default `-` Text `-` MDE `X` API `RELEASED_FOR_KEY_USE
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1225023223_ANNO.htm"
abapFile: "ABENCDS_1225023223_ANNO.html"
keywords: ["insert", "do", "if", "case", "data", "ABENCDS", "1225023223", "ANNO"]
---
