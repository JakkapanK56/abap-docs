---
title: "ABENNEWS-783-ABAP_DOCU"
description: |
  ABENNEWS-783-ABAP_DOCU - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-783-ABAP_DOCU.htm"
abapFile: "ABENNEWS-783-ABAP_DOCU.html"
keywords: ["do", "if", "ABENNEWS", "783", "ABAP", "DOCU"]
---

From release 7.83 on, important settings of the ABAP Keyword Documentation can be configured explicitly. Before, the documentation was configured implicitly from system settings.
...
-   **ICF**
-   Enables or disables the Web Version of the ABAP Keyword Documentation based on [ICF](ABENICF_GLOSRY.html) nodes `/sap/public/bc/abap/docu` and `/sap/bc/abap/docu`.
