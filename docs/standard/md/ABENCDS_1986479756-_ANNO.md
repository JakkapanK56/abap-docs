---
title: "ABENCDS_1986479756-_ANNO"
description: |
  ABENCDS_1986479756-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1986479756-_ANNO.htm"
abapFile: "ABENCDS_1986479756-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1986479756", "ANNO"]
---
...
This annotation indicates up to which level a display hierarchy shall be initially expanded. The origin of a display hierarchy can be hierarchies in CDS, exposed via query view annotations, or an arbitrary leveled runtime hierarchy introduced by the groupBy annotation.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.presentationVariant[ ].initialExpansionLevel`\\ **Scope** `#ENTITY`\\ **Type** `Integer`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html