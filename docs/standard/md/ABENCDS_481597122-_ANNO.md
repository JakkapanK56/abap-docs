...
title: "No KTD found"
description: |
  This annotation contains a detailed description of the data point. You want to use more characters, than allowed in the UI.dataPoint.description. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.kpi .dataPoint.longDescription` Scope `#ELEMENT`
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_481597122-_ANNO.htm"
abapFile: "ABENCDS_481597122-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "481597122", "ANNO"]
---
...
This annotation contains a detailed description of the data point.

You want to use more characters, than allowed in the UI.dataPoint.description.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.kpi[ ].dataPoint.longDescription`\\ **Scope** `#ELEMENT`\\ **Type** `String(250)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `X`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html