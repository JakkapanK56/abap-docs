---
title: "ABENCDS_1483608320_ANNO"
description: |
  ABENCDS_1483608320_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1483608320_ANNO.htm"
abapFile: "ABENCDS_1483608320_ANNO.html"
keywords: ["insert", "do", "if", "case", "data", "ABENCDS", "1483608320", "ANNO"]
---
...
The annotation hidden allows providing a static boolean value, but usually the value will be provided by referencing a Boolean element of the same view using the #(...) syntax.

You want to dynamically switch an annotation on and off.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.connectedFields[ ].hidden`\\ **Scope** `#ELEMENT`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html