...
description: |
  The release contract `C0` permits adding of custom fields at dedicated extension points using the key user app Custom Fields and Logic. Defines allowed changes to the usage of the annotation in a CDS entity with release contract `C0` after its release. Defines whether the annotation may be added
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1748011752_ANNO.htm"
abapFile: "ABENCDS_1748011752_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1748011752", "ANNO"]
---
...
Defines allowed changes to the usage of the annotation in a CDS entity with release contract `C0` after its release.

Defines whether the annotation may be added or removed in a CDS entity with release contract `C0` after its release.
...
**Kind** [ABAP annotation](ABENABAP_ANNOTATION_GLOSRY.html)\\ **Syntax** `CompatibilityContract.c0.allowedChanges.annotation[ ]`\\ **Scope** `#ANNOTATION`\\ **Type** `String(20)`\\ **Enums** `#ADD, #ANY, #CUSTOM, #NONE, #REMOVE`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_abap\_annos.html abencds\_compatibilitycontract\_a.html