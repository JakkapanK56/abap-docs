---
title: "ABENMEMORY_CONSUMPTION_1"
description: |
  ABENMEMORY_CONSUMPTION_1 - Standard ABAP language reference documentation
library: "standard"
...
-   It can also be determined by creating a [memory snapshot](ABENMEMORY_SNAPSHOT_GLOSRY.html) for the [Memory Inspector](ABENMEMORY_INSPECTOR_GLOSRY.html).
