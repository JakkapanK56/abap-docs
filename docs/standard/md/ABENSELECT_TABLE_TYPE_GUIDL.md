---
title: "ABENSELECT_TABLE_TYPE_GUIDL"
description: |
  ABENSELECT_TABLE_TYPE_GUIDL - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENSELECT_TABLE_TYPE_GUIDL.htm"
abapFile: "ABENSELECT_TABLE_TYPE_GUIDL.html"
...
If you use [secondary keys](ABENSECONDARY_KEY_GUIDL.html), the rules mentioned here may be qualified to a certain degree, as the overall costs need to be considered in this case.
