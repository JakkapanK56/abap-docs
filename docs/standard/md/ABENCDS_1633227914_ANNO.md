...
title: "No KTD found"
description: |
  The number is the link to the placeholder in the dynamic label Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Consumption.dynamicLabel.binding .index` Scope `#ELEMENT` Type `Integer` Enums `-` Default `-` Text `-` MDE `
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1633227914_ANNO.htm"
abapFile: "ABENCDS_1633227914_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1633227914", "ANNO"]
---
...
The number is the link to the placeholder in the dynamic label

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.dynamicLabel.binding[ ].index`\\ **Scope** `#ELEMENT`\\ **Type** `Integer`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html