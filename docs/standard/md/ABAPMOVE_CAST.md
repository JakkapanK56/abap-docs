...
title: "ABAPMOVE_CAST"
description: |
  ABAPMOVE_CAST - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPMOVE_CAST.htm"
...
-   An obsolete form of downcast is the statement [`MOVE`](ABAPMOVE_OBS.html) with the addition [`?TO`](ABAPMOVE_OBS.html).
