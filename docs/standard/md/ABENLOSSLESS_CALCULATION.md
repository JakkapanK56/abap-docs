...
description: |
  ABENLOSSLESS_CALCULATION - Standard ABAP language reference documentation
library: "standard"
...
-   For this, see the executable [example](ABENCOMPUTE_EXACT_ABEXA.html).
-   The use of the addition `EXACT` in the obsolete statement [`COMPUTE`](ABAPCOMPUTE.html) is an obsolete form of lossless calculation.
