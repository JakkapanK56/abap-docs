...
description: |
  ABAPCOMPUTE_STRING - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPCOMPUTE_STRING.htm"
abapFile: "ABAPCOMPUTE_STRING.html"
keywords: ["loop", "do", "if", "case", "data", "types", "ABAPCOMPUTE", "STRING"]
---

[Short Reference](ABENSTRING_EXP_SHORTREF.html)
