...
title: "No KTD found"
description: |
  Name of an element, which is used in a filter of the field with the dynamicLabel annotation. The placeholder will be replaced with the filter of the element. Either binding.parameter or binding.element has to be used. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Sy
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1346100757_ANNO.htm"
abapFile: "ABENCDS_1346100757_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1346100757", "ANNO"]
---
...
Name of an element, which is used in a filter of the field with the dynamicLabel annotation. The placeholder will be replaced with the filter of the element. Either binding.parameter or binding.element has to be used.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.dynamicLabel.binding[ ].element`\\ **Scope** `#ELEMENT`\\ **Type** `String(40)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html