...
description: |
  ABENBDL_DEF_AUTH_CONTEXT - Standard ABAP language reference documentation
library: "standard"
...
METHOD read FOR READ \[....\]. \\n[AUTHORITY-CHECK DISABLE BEGIN CONTEXT](ABAPAUTHORITY-CHECK_DISABLE.html) demo\_context~ReadContext. \\n... \\n[AUTHORITY-CHECK DISABLE END](ABAPAUTHORITY-CHECK_DISABLE.html). \\nENDMETHOD.
...
-   By using [`AUTHORITY-CHECK DISABLE BEGIN CONTEXT` ... `AUTHORITY-CHECK DISABLE END`](ABAPAUTHORITY-CHECK_DISABLE.html) in the ABAP behavior pool for a handler or saver method.
