...
title: "No KTD found"
description: |
  Annotations belonging to UI.dataPoint.criticalityCalculation can be used as an alternative to specifying the criticality in the crtiticality element This annotation sets the lowest value that can deviate from the desired value. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.ht
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_599408365-_ANNO.htm"
abapFile: "ABENCDS_599408365-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "599408365", "ANNO"]
---
...
This annotation sets the lowest value that can deviate from the desired value.
