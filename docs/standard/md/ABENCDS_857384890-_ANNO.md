---
title: "ABENCDS_857384890-_ANNO"
description: |
  ABENCDS_857384890-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_857384890-_ANNO.htm"
abapFile: "ABENCDS_857384890-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "857384890", "ANNO"]
---
...
Specifies, in which order text is arranged.

Scope: \[ENTITY, ELEMENT\]

SADL: Translates CDS annotations into the corresponding OData annotations

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.textArrangement`\\ **Scope** `#ELEMENT`, `#ENTITY`\\ **Type** `String(13)`\\ **Enums** `#TEXT_FIRST, #TEXT_LAST, #TEXT_ONLY, #TEXT_SEPARATE`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html