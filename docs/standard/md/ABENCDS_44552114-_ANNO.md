---
title: "ABENCDS_44552114-_ANNO"
description: |
  ABENCDS_44552114-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_44552114-_ANNO.htm"
abapFile: "ABENCDS_44552114-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "44552114", "ANNO"]
---
...
This annotation bundles additional settings for a KPI which are relevant for a separate KPI detail display or for progressive disclosure of the KPI.

This annotation refers to a UI.presentationVariant annotations at the same view via their qualifiers.

PresentationVariants should be used/offered as al-ternative representations of the KPI detail.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.kpi[ ].detail.alternativePresentationVariantQualifiers[ ]`\\ **Scope** `#ELEMENT`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html