...
title: "No KTD found"
description: |
  This annotation specifies the maximum value of a threshold. Note: Can be set by the user to set a maximum value. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.kpi .dataPoint.maximumValue` Scope `#ELEMENT` Type `DecimalFloat` Enums
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_774092449-_ANNO.htm"
abapFile: "ABENCDS_774092449-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "774092449", "ANNO"]
---
...
*Note: Can be set by the user to set a maximum value.*

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.kpi[ ].dataPoint.maximumValue`\\ **Scope** `#ELEMENT`\\ **Type** `DecimalFloat`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html