...
description: |
  ABENNUMBER_TYPES - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNUMBER_TYPES.htm"
abapFile: "ABENNUMBER_TYPES.html"
keywords: ["select", "do", "if", "case", "data", "types", "ABENNUMBER", "TYPES"]
---
...
[Select the numeric type](ABENSELECT_NUMERIC_TYPE_GUIDL.html)
...
To assign numeric values to text fields and text strings, instead of a [conversion](ABENCONVERSION_ELEMENTARY.html) it is often better to use the statement [`WRITE ... TO`](ABAPWRITE_TO.html) or [embedded expressions](ABENSTRING_TEMPLATES_EXPRESSIONS.html) in [string templates](ABENSTRING_TEMPLATES.html) with the associated formatting options.
