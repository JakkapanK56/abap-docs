...
description: |
  ABENRABAX_IMPORT_FROM_DATABASE - Standard ABAP language reference documentation
library: "standard"
...
keywords: ["do", "if", "try", "data", "types", "internal-table", "ABENRABAX", "IMPORT", "FROM", "DATABASE"]
---
