---
title: "ABENCDS_1094519055_ANNO"
description: |
  ABENCDS_1094519055_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1094519055_ANNO.htm"
abapFile: "ABENCDS_1094519055_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1094519055", "ANNO"]
---
...
This annotation gives the relative position of the FieldGroup for the annotated CDS element in the collection of FieldGroup on entity-level. Must be specified to allow interspersing extension elements via extend views.

You want to set the order, in which elements should be positioned in the UI. The value is set in 10 steps.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.fieldGroup[ ].position`\\ **Scope** `#ELEMENT`\\ **Type** `DecimalFloat`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html