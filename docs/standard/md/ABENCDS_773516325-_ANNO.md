...
title: "No KTD found"
description: |
  This annotation contains a description of the datapoint. You want to describe the usage of the annotation for other developers Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.kpi .dataPoint.description` Scope `#ELEMENT` Type `String(120)`
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_773516325-_ANNO.htm"
abapFile: "ABENCDS_773516325-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "773516325", "ANNO"]
---
