---
title: "ABENCDS_937506020-_ANNO"
description: |
  ABENCDS_937506020-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_937506020-_ANNO.htm"
abapFile: "ABENCDS_937506020-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "937506020", "ANNO"]
---
...
This annotation contains a string with the name of the hierarchy view and make possible that the data is then shown on UI as tree table. The projection view should also have the annotation @OData.hierarchy.recursiveHierarchy containing the hierarchy view to expose the hierarchy.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.presentationVariant[ ].recursiveHierarchyQualifier`\\ **Scope** `#ENTITY`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html