...
description: |
  ABENABAP_SQL_NULL_VALUES - Standard ABAP language reference documentation
library: "standard"
...
-   In [Native SQL](ABENNATIVE_SQL_GLOSRY.html) and [AMDP](ABENAMDP_GLOSRY.html), null values passed to ABAP objects are also transformed to their type-dependent initial values.
