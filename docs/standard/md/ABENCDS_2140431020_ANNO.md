---
title: "ABENCDS_2140431020_ANNO"
description: |
  ABENCDS_2140431020_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_2140431020_ANNO.htm"
abapFile: "ABENCDS_2140431020_ANNO.html"
keywords: ["do", "if", "class", "data", "ABENCDS", "2140431020", "ANNO"]
---
...
\- *true*: The view is suitable for data replication. The default is true if this annotation is used.

\- *false*: The view is not suitable for data replication.

Some general rules:

\- Do not add the annotation @Analytics.DataExtraction.enabled to arbitrary CDS views but only to views which shall be explicitly released for data extraction.

\- Only the fields included in the field list of the view are available for a consumer of data extraction. Associations are not exposed via data extraction. If a field from an association shall be available for data extraction it must be included in the field list.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Analytics.dataExtraction.enabled`\\ **Scope** `#HIERARCHY`, `#TABLE_FUNCTION`, `#VIEW`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_analytics\_f.html