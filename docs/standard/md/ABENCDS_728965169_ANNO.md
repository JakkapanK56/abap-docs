---
title: "ABENCDS_728965169_ANNO"
description: |
  ABENCDS_728965169_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_728965169_ANNO.htm"
abapFile: "ABENCDS_728965169_ANNO.html"
keywords: ["do", "while", "if", "data", "types", "ABENCDS", "728965169", "ANNO"]
---
...
Indicate whether the value has an exclusive minimum.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Semantics.valueRange.exclusiveMinimum`\\ **Scope** `#ELEMENT`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_semantics\_f.html