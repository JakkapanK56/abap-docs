...
title: "No KTD found"
description: |
  This annotation contains the URL to an icon image. You want to display an icon. With the iconUrl annotation you can set an URL to an icon. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.identification .iconUrl` Scope `#ELEMENT` Type `String
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_849994507_ANNO.htm"
abapFile: "ABENCDS_849994507_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "849994507", "ANNO"]
---
