...
description: |
  ABENSTRING_TEMPLATES_SEPARATORS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENSTRING_TEMPLATES_SEPARATORS.htm"
...
-   The control characters have no effect on classical dynpros and [lists](ABENABAP_DYNPRO_LIST.html). They appear in a list output as the `#` character. However, you can see the effect in the textedit control, for example.
