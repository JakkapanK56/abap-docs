...
description: |
  Long Forms of ABAP EML Statements Dynamic Forms of ABAP EML Statements -   You can use the method `get_current_context` of class `CL_ABAP_BEHV_AUX` to obtain context information. Among others, you can determine if the running handler is running in privileged mode, e. g. as follows: -   `cl_abap_behv
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPEML_PRIVILEGED.htm"
...
-   `cl_abap_behv_aux=>get_current_context( IMPORTING privileged = FINAL(priv) ).`
