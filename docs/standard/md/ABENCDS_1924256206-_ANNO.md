...
title: "No KTD found"
description: |
  This annotation contains language-dependent and human-readable text for labels and captions in the UI. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.identification .label` Scope `#ELEMENT` Type `String(60)` Enums `-` Default `-
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1924256206-_ANNO.htm"
abapFile: "ABENCDS_1924256206-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1924256206", "ANNO"]
---
...
This annotation contains language-dependent and human-readable text for labels and captions in the UI.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.identification[ ].label`\\ **Scope** `#ELEMENT`\\ **Type** `String(60)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `X`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html