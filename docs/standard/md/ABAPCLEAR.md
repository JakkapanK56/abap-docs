...
title: "ABAPCLEAR"
description: |
  ABAPCLEAR - Standard ABAP language reference documentation
library: "standard"
...
keywords: ["insert", "delete", "do", "if", "case", "catch", "class", "data", "types", "internal-table", "ABAPCLEAR"]
---

[Short Reference](ABAPCLEAR_SHORTREF.html)

``CLEAR dobj [\ \{WITH val [IN \{CHARACTER|BYTE\} MODE]\ \}\             |\ \{[`WITH NULL`](ABAPCLEAR_WITH_NULL.html)\}\ ].``
...
If the obsolete addition [`WITH NULL`](ABAPCLEAR_WITH_NULL.html) is used, all bytes of a flat data object can be replaced by hexadecimal 0 outside classes.
