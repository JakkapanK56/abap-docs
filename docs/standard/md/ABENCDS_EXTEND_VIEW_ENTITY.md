---
title: "The following CDS view entity extension"
description: |
  adds two view fields to the existing CDS view entity The class `CL_DEMO_CDS_VIEW_EXTENSION_VE` uses the statement `SELECT`(ABAPSELECT.html) to access the extended view entity. This addition must be specified if elements not defined using aggregate expressions are added to a view with aggregate ex
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_EXTEND_VIEW_ENTITY.htm"
abapFile: "ABENCDS_EXTEND_VIEW_ENTITY.html"
keywords: ["select", "delete", "if", "try", "class", "data", "types", "ABENCDS", "EXTEND", "VIEW", "ENTITY"]
---
...
The class `CL_DEMO_CDS_VIEW_EXTENSION_VE` uses the statement [`SELECT`](ABAPSELECT.html) to access the extended view entity.
