...
title: "No KTD found"
description: |
  This annotation contains the URL of an image representing an entity Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.badge.typeImageUrl` Scope `#ENTITY` Type `String(1024)` Enums `-` Default `-` Text `-` MDE `X` API
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_645917463_ANNO.htm"
abapFile: "ABENCDS_645917463_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "645917463", "ANNO"]
---
