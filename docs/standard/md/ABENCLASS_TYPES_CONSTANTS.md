...
description: |
  ABENCLASS_TYPES_CONSTANTS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCLASS_TYPES_CONSTANTS.htm"
...
In particular, it is possible to define data types in the public visibility section of global classes, which makes the use of [type pools](ABENTYPE_POOL_GLOSRY.html) in this context obsolete.
...
In particular, it is possible to declare constants in the public visibility section of global classes, which makes use of [type pools](ABENTYPE_POOL_GLOSRY.html) in this context obsolete.
