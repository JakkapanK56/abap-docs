...
description: |
  ABENFLOATING_POINT_FUNCTIONS - Standard ABAP language reference documentation
library: "standard"
...
-   The functions listed here are some of the functions that can be used in the obsolete [extended functional operand positions](ABENEXTENDED_FUNCTIONAL_POSITIONS.html) if their argument is a single data object.
