...
description: |
  ABENDDIC_DATABASE_TABLES_SIZ_CAT - Standard ABAP language reference documentation
library: "standard"
...
-   In transaction `SE11`, the [input help](ABENINPUT_HELP_GLOSRY.html) for *Size Category* in technical settings shows the interval limits valid for the current DDIC database table.
