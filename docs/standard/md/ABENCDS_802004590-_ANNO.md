...
title: "No KTD found"
description: |
  This annotationv expresses how multiple invocations of the same action are handled. A user selects five items in a list and wants to copy them. One item cannot be copied. This item will not be copied, the other four items are copied. A user selects five items in a list and wants to copy them. One it
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_802004590-_ANNO.htm"
abapFile: "ABENCDS_802004590-_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "802004590", "ANNO"]
---
...
This annotationv expresses how multiple invocations of the same action are handled.
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.identification[ ].invocationGrouping`\\ **Scope** `#ELEMENT`\\ **Type** `String(12)`\\ **Enums** `#CHANGE_SET, #ISOLATED`\\ **Default** `#ISOLATED`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html