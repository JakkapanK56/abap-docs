...
title: "Runtime"
description: |
  Defines an additional binding condition for the value help on the same target value help provider entity for filtering the value help result list and/or returning values from the selected value help record. Specifies the local element that is linked to the element or parameter in the target value he
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_274352458-_ANNO.htm"
abapFile: "ABENCDS_274352458-_ANNO.html"
keywords: ["select", "do", "if", "data", "types", "ABENCDS", "274352458", "ANNO"]
---
...
Specifies the local element that is linked to the element or parameter in the target value help provider entity for the additional binding.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.valueHelpDefinition[ ].additionalBinding[ ].localElement`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html