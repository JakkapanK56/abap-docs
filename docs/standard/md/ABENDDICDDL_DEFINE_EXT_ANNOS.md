...
description: |
  ABENDDICDDL_DEFINE_EXT_ANNOS - Standard ABAP language reference documentation
library: "standard"
...
-   Extensibility annotations of DDIC structures and DDIC database tables can only be maintained in [ABAP development tools for Eclipse](ABENADT_GLOSRY.html). Maintenance in transaction `SE11` is not supported.
