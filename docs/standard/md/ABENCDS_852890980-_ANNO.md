...
title: "No KTD found"
description: |
  No KTD found Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Semantics.systemTime.localInstanceLastChangedAt` Scope `#ELEMENT`, `#PARAMETER`, `#SIMPLE_TYPE` Type `Boolean` Enums `-` Default `true` Text `-` MDE `-` API
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_852890980-_ANNO.htm"
abapFile: "ABENCDS_852890980-_ANNO.html"
keywords: ["do", "while", "if", "data", "types", "ABENCDS", "852890980", "ANNO"]
---
