...
title: "No KTD found"
description: |
  This annotation is used as an alternative to dataPoint.trend trend can be calculated based on the values given in the trendCalculation annotation This annotation contains a constant value, that specifies a difference resulting in a strongDown-trend. Kind Framework-specific annotation(ABENFRMWR
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_67732014_ANNO.htm"
abapFile: "ABENCDS_67732014_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "67732014", "ANNO"]
---
...
This annotation contains a constant value, that specifies a difference resulting in a strongDown-trend.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.kpi[ ].dataPoint.trendCalculation.strongDownDifference`\\ **Scope** `#ELEMENT`\\ **Type** `DecimalFloat`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html