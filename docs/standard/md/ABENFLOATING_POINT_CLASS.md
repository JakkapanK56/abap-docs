...
description: |
  ABENFLOATING_POINT_CLASS - Standard ABAP language reference documentation
library: "standard"
...
The [rounding functions](ABENROUNDING_FUNCTION_GLOSRY.html)\\ `round` and `rescale` can be used to round and rescale decimal floating point numbers.
