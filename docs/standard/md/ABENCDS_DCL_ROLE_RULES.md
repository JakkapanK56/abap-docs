...
description: |
  ABENCDS_DCL_ROLE_RULES - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_DCL_ROLE_RULES.htm"
...
\\ 
2\. ``... [`inherited_rule`](ABENCDS_DCL_ROLE_INHERITED_RULE.html)\       [[`conditional_rule`](ABENCDS_DCL_ROLE_COND_RULE.html)|[`grant_rule`](ABENCDS_DCL_ROLE_GRANT_RULE.html)]\       [[`conditional_rule`](ABENCDS_DCL_ROLE_COND_RULE.html)|[`grant_rule`](ABENCDS_DCL_ROLE_GRANT_RULE.html)]\        ...``\\ 
\\ 
...
Multiple access rules can be combined in a single CDS role, but an inherited access rule [`inherited_rule`](ABENCDS_DCL_ROLE_INHERITED_RULE.html) can only occur once.
...
-   Obsolete inherited access rules [`inherited_rule`](ABENCDS_DCL_ROLE_INHERITED_RULE.html) applied from existing CDS roles; [inheritance conditions](ABENCDS_F1_COND_INHERIT.html) should be used instead of inheritance rules.
