...
title: "Runtime"
description: |
  Defines an additional binding condition for the value help on the same target value help provider entity for filtering the value help result list and/or returning values from the selected value help record. The binding specifies an additional filter-criterion. Kind Framework-specific annotation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1441351652_ANNO.htm"
abapFile: "ABENCDS_1441351652_ANNO.html"
keywords: ["select", "do", "if", "data", "types", "ABENCDS", "1441351652", "ANNO"]
---
...
The binding specifies an additional filter-criterion.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.valueHelpDefinition[ ].additionalBinding[ ].usage`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `String(30)`\\ **Enums** `#FILTER, #FILTER_AND_RESULT, #RESULT`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html