...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Consumption.hierarchyNodeSelection.hierarchyBinding.value` Scope `#PARAMETER` Type `String(512)` Enums `-` Default `-` Text `-` MDE `X` API `RELEASED_FOR_KEY_USER_APP
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1730821167_ANNO.htm"
abapFile: "ABENCDS_1730821167_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "1730821167", "ANNO"]
---
