---
title: "ABENCDS_884538153-_ANNO"
description: |
  ABENCDS_884538153-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_884538153-_ANNO.htm"
abapFile: "ABENCDS_884538153-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "884538153", "ANNO"]
---
...
This annotation defines whether the values of the value help provider view are automatically retrieved without setting a filter when invoking the value help, or whether they must be explicitly requested.

The annotation must be used in the value help provider entity.

(default in OData V4)

(default in OData V2)

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.valueHelpDefault.fetchValues`\\ **Scope** `#ENTITY`\\ **Type** `String(30)`\\ **Enums** `#AUTOMATICALLY_WHEN_DISPLAYED, #ON_EXPLICIT_REQUEST`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html