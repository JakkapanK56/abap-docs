...
description: |
  ABENABAP_XSLT_ASXML_SCHEMA - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENABAP_XSLT_ASXML_SCHEMA.htm"
...
-   See the associated [executable example](ABENABAP_JSON_ASJSON_XSD_ABEXA.html).
...
-   Any available SRID can be used. Refer to the program `ABAP_DOCU_SHOW_SPATIAL_REF_SYS`.
