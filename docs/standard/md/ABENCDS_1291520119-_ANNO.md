...
description: |
  The release contract `C2` guarantees a stable interface for use as remote API. Defines allowed changes to the usage of the annotation in a CDS entity with release contract `C2` after its release. Defines whether the annotation values may be changed in a CDS entity with release contract `C2` after
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1291520119-_ANNO.htm"
abapFile: "ABENCDS_1291520119-_ANNO.html"
keywords: ["update", "do", "if", "data", "ABENCDS", "1291520119", "ANNO"]
---
...
Defines whether the annotation values may be changed in a CDS entity with release contract `C2` after its release.
