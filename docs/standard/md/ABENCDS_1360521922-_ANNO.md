...
title: "No KTD found"
description: |
  This annotation contains marker to explicitly exclude a CDS element from the collection of selectionField for a derived view. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.identification .exclude` Scope `#ELEMENT` Type `Boolean` Enums
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1360521922-_ANNO.htm"
abapFile: "ABENCDS_1360521922-_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "1360521922", "ANNO"]
---
...
This annotation contains marker to explicitly exclude a CDS element from the collection of selectionField for a derived view.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.identification[ ].exclude`\\ **Scope** `#ELEMENT`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html