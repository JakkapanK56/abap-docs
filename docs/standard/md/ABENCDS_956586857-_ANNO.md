---
title: "ABENCDS_956586857-_ANNO"
description: |
  ABENCDS_956586857-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_956586857-_ANNO.htm"
abapFile: "ABENCDS_956586857-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "956586857", "ANNO"]
---
...
Specifies (as text) how the content of the aspect entity is audited.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `AccessControl.auditing.specification`\\ **Scope** `#TABLE_ENTITY`, `#VIEW`\\ **Type** `String(1000)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_accesscontrol\_f.html