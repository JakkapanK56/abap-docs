---
title: "ABENCDS_1975661854-_ANNO"
description: |
  ABENCDS_1975661854-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1975661854-_ANNO.htm"
abapFile: "ABENCDS_1975661854-_ANNO.html"
keywords: ["do", "while", "if", "data", "types", "ABENCDS", "1975661854", "ANNO"]
---
...
This annotation allows tagging fields that contain a unique identifier for a data subject.
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Semantics.personalData.fieldSemantics`\\ **Scope** `#ELEMENT`\\ **Type** `String(30)`\\ **Enums** `#DATA_SUBJECT_ID, #LEGAL_ENTITY_ID, #SUBJECT_ID_TYPE`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_semantics\_f.html