...
title: "ABENOBJECT"
description: |
  ABENOBJECT - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENOBJECT.htm"
abapFile: "ABENOBJECT.html"
keywords: ["delete", "do", "method", "class", "data", "field-symbol", "ABENOBJECT"]
---
...
For cross-transaction objects, there are [shared objects](ABENSHARED_OBJECTS_GLOSRY.html) that can be accessed by all programs of an AS instance at the same time.

[Object Services](ABENOBJECT_SERVICES_GLOSRY.html) are available for handling persistent objects in the database. These can link the attributes of objects with the content of DDIC database tables and can execute object-oriented transactions.
...
In addition to the regular references, there are [weak references](ABENCL_ABAP_WEAK_REFERENCE.html) represented by objects that do not keep an object alive.
