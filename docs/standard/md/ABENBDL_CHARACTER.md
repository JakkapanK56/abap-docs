...
description: |
  ABENBDL_CHARACTER - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENBDL_CHARACTER.htm"
...
-   Specifies the [RAP draft table](ABENDRAFT_TABLE_GLOSRY.html)\\ `DraftTableName` for storing data changes of [draft instances](ABENRAP_DRAFT_INSTANCE_GLOSRY.html). This addition is only available for draft-enabled scenarios using the addition [`with draft`](ABENBDL_WITH_DRAFT.html).
