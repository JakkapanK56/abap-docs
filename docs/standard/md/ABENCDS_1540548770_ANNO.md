...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1540548770_ANNO.htm"
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Aggregation.exception`\\ **Scope** `#ELEMENT`\\ **Type** `String(30)`\\ **Enums** `#AVG, #COUNT, #COUNT_DISTINCT, #FIRST, #LAST, #MAX, #MEDIAN, #MIN, #NHA, #STANDARD_DEVIATION, #SUM, #VARIANCE`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_aggregation\_f.html