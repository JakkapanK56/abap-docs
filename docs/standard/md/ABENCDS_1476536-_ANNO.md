...
title: "No KTD found"
description: |
  No KTD found No KTD found Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.kpi .dataPoint.referencePeriod.description` Scope `#ELEMENT` Type `String(120)` Enums `-` Default `-` Text `X` MDE `X` API `RELEASED_FOR_
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1476536-_ANNO.htm"
abapFile: "ABENCDS_1476536-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1476536", "ANNO"]
---
