...
description: |
  ABENSELECT_HIERARCHY_DATA - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENSELECT_HIERARCHY_DATA.htm"
abapFile: "ABENSELECT_HIERARCHY_DATA.html"
keywords: ["select", "if", "method", "class", "data", "internal-table", "ABENSELECT", "HIERARCHY", "DATA"]
---
...
-   In an ABAP program, it is possible to use the method `USE_FEATURES` of the class [`CL_ABAP_DBFEATURES`](ABENCL_ABAP_DBFEATURES.html) to check whether the current database system or a database system accessed using a [secondary connection](ABENSECONDARY_DB_CONNECTION_GLOSRY.html) supports access to hierarchy data. This requires the constant `HIERARCHIES` of this class to be passed to the method in an internal table.
-   Accessing hierarchy data enforces the [strict mode from ABAP release 7.73](ABENABAP_SQL_STRICTMODE_773.html).
