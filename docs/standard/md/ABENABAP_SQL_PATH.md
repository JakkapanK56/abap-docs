...
description: |
  ABENABAP_SQL_PATH - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENABAP_SQL_PATH.htm"
...
-   If parameters are passed or attributes specified in a path expression of a [column specification](ABENABAP_SQL_COLUMNS.html), the syntax check runs in [strict mode from ABAP release 7.69](ABENABAP_SQL_STRICTMODE_769.html).
