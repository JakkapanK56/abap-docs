...
description: |
  ABAPTEST-INJECTION - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPTEST-INJECTION.htm"
abapFile: "ABAPTEST-INJECTION.html"
keywords: ["select", "do", "while", "if", "method", "class", "data", "types", "ABAPTEST", "INJECTION"]
---

[Short Reference](ABAPTEST-INJECTION_SHORTREF.html)
