...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Semantics.contact.type` Scope `#ELEMENT`, `#PARAMETER`, `#SIMPLE_TYPE` Type `String(12)` Enums `#ORGANIZATION, #PERSON` Default `-` Text `-` MDE `-` API `-` abenabap.ht
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1557470651-_ANNO.htm"
abapFile: "ABENCDS_1557470651-_ANNO.html"
keywords: ["do", "while", "if", "data", "types", "ABENCDS", "1557470651", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Semantics.contact.type`\\ **Scope** `#ELEMENT`, `#PARAMETER`, `#SIMPLE_TYPE`\\ **Type** `String(12)`\\ **Enums** `#ORGANIZATION, #PERSON`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_semantics\_f.html