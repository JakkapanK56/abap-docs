...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.dataPoint.criticalityCalculation.constantThresholds .toleranceRangeLowValue` Scope `#ELEMENT` Type `DecimalFloat` Enums `-` Default `-` Text `-` MDE `X` API `RELEA
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_953238141-_ANNO.htm"
abapFile: "ABENCDS_953238141-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "953238141", "ANNO"]
---
