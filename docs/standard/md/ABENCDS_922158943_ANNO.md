...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Consumption.derivation.binding .value` Scope `#ELEMENT`, `#PARAMETER` Type `String(512)` Enums `-` Default `-` Text `-` MDE `X` API `RELEASED_FOR_KEY_USER_APPS, RELEA
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_922158943_ANNO.htm"
abapFile: "ABENCDS_922158943_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "922158943", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.derivation.binding[ ].value`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `String(512)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html