---
title: "ABENNEWS-754-TYPES"
description: |
  ABENNEWS-754-TYPES - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-754-TYPES.htm"
abapFile: "ABENNEWS-754-TYPES.html"
keywords: ["class", "data", "types", "ABENNEWS", "754", "TYPES"]
---
...
-   Time stamp fields are formatted specially in [string templates](ABENSTRING_TEMPLATE_GLOSRY.html) or using the statement [`WRITE TO`](ABAPWRITE_TO.html).
