...
description: |
  ABENNUMERICAL_FUNCTIONS - Standard ABAP language reference documentation
library: "standard"
...
-   The functions listed here are some of the functions that can also be used in the obsolete [extended functional operand positions](ABENEXTENDED_FUNCTIONAL_POSITIONS.html), even if their argument is a single data object.
