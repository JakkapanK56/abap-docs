...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.fieldGroup .valueQualifier` Scope `#ELEMENT` Type `String(120)` Enums `-` Default `-` Text `-` MDE `X` API `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLAT
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1263465086-_ANNO.htm"
abapFile: "ABENCDS_1263465086-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1263465086", "ANNO"]
---
