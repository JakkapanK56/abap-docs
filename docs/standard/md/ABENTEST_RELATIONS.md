...
description: |
  ABENTEST_RELATIONS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENTEST_RELATIONS.htm"
...
-   Test relations are ignored, when starting the unit tests of an ABAP program directly from the [repository browser](ABENREPOSITORY_BROWSER_GLOSRY.html) or an editor of the [ABAP Workbench](ABENABAP_WORKBENCH_GLOSRY.html) in SAP GUI.
