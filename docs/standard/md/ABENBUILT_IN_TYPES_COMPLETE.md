...
description: |
  ABENBUILT_IN_TYPES_COMPLETE - Standard ABAP language reference documentation
library: "standard"
...
-   The maximum size of a string is determined by the [profile parameter](ABENPROFILE_PARAMETER_GLOSRY.html)\\ `ztta/max_memreq_MB` (see [Maximum Size of Dynamic Data Objects](ABENMEMORY_CONSUMPTION_2.html)).
