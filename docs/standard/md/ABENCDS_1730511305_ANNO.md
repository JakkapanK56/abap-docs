...
title: "No KTD found"
description: |
  No KTD found This annotation defines whether criticality is represented by an icon or not. ##Use case You don't want the criticality to be displayed as 'neutral (0)' or 'critical (2)' but instead you want to show it as a an icon for example an arrow pointing up or down. Kind Framework-specific
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1730511305_ANNO.htm"
abapFile: "ABENCDS_1730511305_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1730511305", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.badge.headLine.criticalityRepresentation`\\ **Scope** `#ENTITY`\\ **Type** `String(12)`\\ **Enums** `#WITHOUT_ICON, #WITH_ICON`\\ **Default** `#WITHOUT_ICON`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html