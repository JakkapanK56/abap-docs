...
title: "No KTD found"
description: |
  This annotation uniquely identifies alternative values for an annotation; omission means the OData term application without explicit qualifier. You want to group Annotations and reuse the set list. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.selection
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1615756015-_ANNO.htm"
abapFile: "ABENCDS_1615756015-_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "1615756015", "ANNO"]
---
...
You want to group Annotations and reuse the set list.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.selectionField[ ].qualifier`\\ **Scope** `#ELEMENT`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html