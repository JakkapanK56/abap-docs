...
title: "No KTD found"
description: |
  This annotation contains a path to a structural element containing the navigation URL. You want to correctly link towards a structural element the url annotation needs to be used. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.identification .url`
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1170563889-_ANNO.htm"
abapFile: "ABENCDS_1170563889-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1170563889", "ANNO"]
---
...
This annotation contains a path to a structural element containing the navigation URL.

You want to correctly link towards a structural element the url annotation needs to be used.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.identification[ ].url`\\ **Scope** `#ELEMENT`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html