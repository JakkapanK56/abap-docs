---
title: "ABENCDS_108177741_ANNO"
description: |
  ABENCDS_108177741_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_108177741_ANNO.htm"
abapFile: "ABENCDS_108177741_ANNO.html"
keywords: ["insert", "do", "if", "case", "data", "ABENCDS", "108177741", "ANNO"]
---
...
This annotation represents the path to an element of an associated CDS view. The path is converted to an OData NavigationPropertyPath. Using this annotation, you can link from the header part of an object view floorplan to a target element. You need to specify UI.lineItem.targetElement when you use the annotation UI.lineItem.type of type *WITH\_NAVIGATION\_PATH*.

You want to provide background information to an item that is opened on the object view floorplan.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.connectedFields[ ].targetElement`\\ **Scope** `#ELEMENT`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html