...
title: "No KTD found"
description: |
  No KTD found Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.connectedFields .semanticObjectBinding .localElement` Scope `#ELEMENT` Type `ElementRef` Enums `-` Default `-` Text `-` MDE `X` API `RELEASED_FOR_KE
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1714201843-_ANNO.htm"
abapFile: "ABENCDS_1714201843-_ANNO.html"
keywords: ["insert", "do", "if", "case", "data", "ABENCDS", "1714201843", "ANNO"]
---
