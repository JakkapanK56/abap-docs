...
title: "No KTD found"
description: |
  No KTD found Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.chart .dimensionAttributes .valuesForSequentialColorLevels ` Scope `#ENTITY` Type `String(1024)` Enums `-` Default `-` Text `-` MDE `X` API `RELEA
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1503083881_ANNO.htm"
abapFile: "ABENCDS_1503083881_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1503083881", "ANNO"]
---
