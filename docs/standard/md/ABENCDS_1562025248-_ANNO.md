---
title: "ABENCDS_1562025248-_ANNO"
description: |
  ABENCDS_1562025248-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1562025248-_ANNO.htm"
abapFile: "ABENCDS_1562025248-_ANNO.html"
keywords: ["select", "do", "if", "case", "data", "ABENCDS", "1562025248", "ANNO"]
---
...
Specifies the value for the node.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.filter.defaultHierarchyNode.node[ ].value`\\ **Scope** `#ELEMENT`\\ **Type** `String(512)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html