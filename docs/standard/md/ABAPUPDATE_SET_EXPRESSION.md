...
description: |
  ABAPUPDATE_SET_EXPRESSION - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPUPDATE_SET_EXPRESSION.htm"
...
-   When a [host expression](ABENABAP_SQL_HOST_EXPRESSIONS.html) is specified on the right side, the syntax check is performed in a [strict mode](ABENABAP_SQL_STRICTMODE_760.html), which handles the statement more strictly than the regular syntax check.
