...
description: |
  ABENSQL_TS_TIMESTAMP_FUNC - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENSQL_TS_TIMESTAMP_FUNC.htm"
...
The use of the functions `TSTMP_IS_VALID`, `TSTMP_CURRENT_UTCTIMESTAMP( )`, `TSTMP_SECONDS_BETWEEN`, and `TSTMP_ADD_SECONDS` enforces the [strict mode from ABAP release 7.71](ABENABAP_SQL_STRICTMODE_771.html).
