...
description: |
  ABENSTRING_EXPRESSION_POSITIONS - Standard ABAP language reference documentation
library: "standard"
...
-   [`LOG-POINT ... SUBKEY sub ...`](ABAPLOG-POINT.html)
-   Operands `text` and `dobj1` to `dobj4` in the statements
-   `MESSAGE [text](ABAPMESSAGE_TEXT.html) ...`\\
