...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPMOVE-CORRESPONDING.htm"
...
[Short Reference](ABAPMOVE-CORRESPONDING_SHORTREF.html)
...
-   The same runtime errors can occur as for [`MOVE`](ABAPMOVE.html) and [`MOVE EXACT`](ABAPMOVE_EXACT.html).
-   The same runtime errors can occur as for [`INSERT itab`](ABAPINSERT_ITAB.html).
