...
description: |
  ABENNEWS-784-ABAP_SQL - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-784-ABAP_SQL.htm"
...
If one of the new features listed above or one of the new CDS system table functions [`SERIES_GENERATE_`](ABENCDS_SERIES_GENERATORS.html) is used in an ABAP SQL statement, the syntax check is performed in a [strict mode](ABENABAP_SQL_STRICTMODE_784.html), which handles the statement more strictly than the regular syntax check.
