...
title: "ABAPASSIGN"
description: |
  ABAPASSIGN - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPASSIGN.htm"
abapFile: "ABAPASSIGN.html"
keywords: ["do", "if", "case", "class", "data", "types", "internal-table", "field-symbol", "ABAPASSIGN"]
---

[Short Reference](ABAPASSIGN_SHORTREF.html)

``ASSIGN [`mem_area`](ABAPASSIGN_MEM_AREA.html) TO <fs> [`casting_spec`](ABAPASSIGN_CASTING.html)\                          [`range_spec`](ABAPASSIGN_RANGE.html)\                          [[`ELSE UNASSIGN`](ABAPASSIGN_ELSE_UNASSIGN.html)].``
...
-   *Cause:* A dynamically specified component does not exist.
    *Runtime error:*\\ `ASSIGN_ILLEGAL_COMPONENT`\\
...
FIELD-SYMBOLS TYPE n. \\nFIELD-SYMBOLS TYPE n. \\nFIELD-SYMBOLS TYPE n. \\n\\ \\nASSIGN sy-datlo+0(4) TO . \\nASSIGN sy-datlo+4(2) TO . \\nASSIGN sy-datlo+6(2) TO . \\n\\ \\ncl\_demo\_output=>new( \\n )->write( \\ \\n )->write( \\ \\n )->display( ). `**sy-subrc**` **Meaning** 0 Assignment was successful. 4 Assignment was not successful. 8 Assignment of [table expression](ABAPASSIGN_MEM_AREA_WRITABLE_EXP.html) was not successful. abenabap.html abenabap\_reference.html abenabap\_data\_working.html abenvalue\_assignments.html abenreference\_assignments.html abenset\_field\_symbols.html