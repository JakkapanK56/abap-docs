...
title: "No KTD found"
description: |
  Annotations belonging to UI.dataPoint.criticalityCalculation can be used as an alternative to specifying the criticality in the crtiticality element This annotation sets the lowest tolerated specification limit for the criticality calculation. Kind Framework-specific annotation(ABENFRMWRK_ANNO
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_862979794_ANNO.htm"
abapFile: "ABENCDS_862979794_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "862979794", "ANNO"]
---
...
This annotation sets the lowest tolerated specification limit for the criticality calculation.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.kpi[ ].dataPoint.criticalityCalculation.toleranceRangeLowValue`\\ **Scope** `#ELEMENT`\\ **Type** `DecimalFloat`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html