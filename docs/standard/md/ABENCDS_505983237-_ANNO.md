...
title: "No KTD found"
description: |
  No KTD found Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.connectedFields .semanticObjectBinding .localParameter` Scope `#ELEMENT` Type `ParameterRef` Enums `-` Default `-` Text `-` MDE `X` API `RELEASED_FO
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_505983237-_ANNO.htm"
abapFile: "ABENCDS_505983237-_ANNO.html"
keywords: ["insert", "do", "if", "case", "data", "ABENCDS", "505983237", "ANNO"]
---
