...
title: "Home address"
description: |
  Work address Preferred address (default) Other address Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Semantics.address.type ` Scope `#ELEMENT`, `#PARAMETER`, `#SIMPLE_TYPE` Type `String(10)` Enums `#HOME, #OTHER, #PREF, #WORK` Defau
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_157700015-_ANNO.htm"
abapFile: "ABENCDS_157700015-_ANNO.html"
keywords: ["do", "while", "if", "case", "data", "types", "ABENCDS", "157700015", "ANNO"]
---
...
This annotation tags an element that contains an address.
...
Preferred address (default)

Other address

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Semantics.address.type[ ]`\\ **Scope** `#ELEMENT`, `#PARAMETER`, `#SIMPLE_TYPE`\\ **Type** `String(10)`\\ **Enums** `#HOME, #OTHER, #PREF, #WORK`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_semantics\_f.html