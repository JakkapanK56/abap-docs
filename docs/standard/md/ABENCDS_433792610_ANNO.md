...
title: "No KTD found"
description: |
  This annotation contains a language-dependent text. If omitted, the @EndUserText.label of the annotated entity or view is used. You want to give an annotation a title use the title annotation. This annotation allows to not display an annotation via a boolean value. You want to dynamically switch an
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_433792610_ANNO.htm"
abapFile: "ABENCDS_433792610_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "433792610", "ANNO"]
---
...
This annotation contains a language-dependent text. If omitted, the @EndUserText.label of the annotated entity or view is used.

You want to give an annotation a title use the title annotation.
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.note.title.hidden`\\ **Scope** `#ENTITY`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html