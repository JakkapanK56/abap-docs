...
description: |
  ABAPTYPES_TABCAT - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPTYPES_TABCAT.htm"
abapFile: "ABAPTYPES_TABCAT.html"
keywords: ["select", "insert", "if", "method", "class", "data", "types", "internal-table", "field-symbol", "ABAPTYPES", "TABCAT"]
---
...
[Use a suitable table category](ABENSELECT_TABLE_TYPE_GUIDL.html)
