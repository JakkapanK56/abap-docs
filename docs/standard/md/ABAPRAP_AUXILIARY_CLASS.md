...
description: |
  ABAPRAP_AUXILIARY_CLASS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPRAP_AUXILIARY_CLASS.htm"
...
-   The [RAP authorization context](ABENCDS_AUTH_CON_GLOSRY.html) of the associated RAP BO can be activated or deactivated using [`AUTHORITY-CHECK DISABLE BEGIN CONTEXT ...`](ABAPAUTHORITY-CHECK_DISABLE.html) and [`AUTHORITY-CHECK DISABLE END`](ABAPAUTHORITY-CHECK_DISABLE.html).
