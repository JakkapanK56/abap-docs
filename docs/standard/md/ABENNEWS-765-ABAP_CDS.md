...
description: |
  ABENNEWS-765-ABAP_CDS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-765-ABAP_CDS.htm"
abapFile: "ABENNEWS-765-ABAP_CDS.html"
keywords: ["select", "if", "case", "class", "data", "types", "ABENNEWS", "765", "ABAP", "CDS"]
---
...
Metadata extensions are [included](ABENCDS_META_DATA_EXTENSION_EVAL.html) by default in the [evaluation of annotations](ABENCDS_ANNOTATIONS_ANALYSIS.html) with the class `CL_DD_DDL_ANNOTATION_SERVICE`.
