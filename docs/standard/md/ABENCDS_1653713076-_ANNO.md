---
title: "You want to set a human readable label for a predefined group of fields together"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.connectedFields .groupLabel` Scope `#ELEMENT` Type `String(60)` Enums `-` Default `-` Text `X` MDE `X` API `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLAT
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1653713076-_ANNO.htm"
abapFile: "ABENCDS_1653713076-_ANNO.html"
keywords: ["insert", "do", "if", "case", "data", "ABENCDS", "1653713076", "ANNO"]
---
...
This annotation contains language-dependent text that is used as label for the field group. The first occurrence for a given qualifier wins. Other occurrences for the same qualifier are redundant.

You want to set a human readable label for a predefined group of fields together

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.connectedFields[ ].groupLabel`\\ **Scope** `#ELEMENT`\\ **Type** `String(60)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `X`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html