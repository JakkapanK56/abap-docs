...
title: "No KTD found"
description: |
  This annotation specifies the minimum value of a threshold. Note: Can be set by the user to set a minimum value. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.kpi .dataPoint.minimumValue` Scope `#ELEMENT` Type `DecimalFloat` Enums
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1102010805_ANNO.htm"
abapFile: "ABENCDS_1102010805_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1102010805", "ANNO"]
---
...
This annotation specifies the minimum value of a threshold.

*Note: Can be set by the user to set a minimum value.*

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.kpi[ ].dataPoint.minimumValue`\\ **Scope** `#ELEMENT`\\ **Type** `DecimalFloat`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html