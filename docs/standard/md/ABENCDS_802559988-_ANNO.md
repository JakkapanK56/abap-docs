---
title: "ABENCDS_802559988-_ANNO"
description: |
  ABENCDS_802559988-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_802559988-_ANNO.htm"
abapFile: "ABENCDS_802559988-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "802559988", "ANNO"]
---
...
This annotation contains an array of zero or more element references for the numeric axes of a chart. The exact semantics depend on the chart type.

You want to label the axis of the chart, you can use the @UI.chart.measures to label and set the numeric elements on a chart

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.chart[ ].measures[ ]`\\ **Scope** `#ENTITY`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html