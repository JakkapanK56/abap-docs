---
title: "ABENEXCEPTION_CATEGORY_GUIDL"
description: |
  ABENEXCEPTION_CATEGORY_GUIDL - Standard ABAP language reference documentation
library: "standard"
