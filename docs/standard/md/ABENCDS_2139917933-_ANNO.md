---
title: "ABENCDS_2139917933-_ANNO"
description: |
  ABENCDS_2139917933-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_2139917933-_ANNO.htm"
abapFile: "ABENCDS_2139917933-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "2139917933", "ANNO"]
---
...
This annotation describes how to group multiple invocations of the same action on multiple instances.

If not all items can be copied but the user still wants to copy the majority of them except the one that can't be copied.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.statusInfo[ ].invocationGrouping`\\ **Scope** `#ELEMENT`\\ **Type** `String(12)`\\ **Enums** `#CHANGE_SET, #ISOLATED`\\ **Default** `#ISOLATED`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html