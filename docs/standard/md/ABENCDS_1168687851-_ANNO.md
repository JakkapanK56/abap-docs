...
title: "No KTD found"
description: |
  This annotation creates a title for the badge. It is a required DataField restricted to the types, WITH_NAVIGATION_PATH, and WITH_URL. This annotation contains the URL to an icon image. You want to set an icon, you will need to submit an URL to an image. Kind Framework-specific annotatio
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1168687851-_ANNO.htm"
abapFile: "ABENCDS_1168687851-_ANNO.html"
keywords: ["do", "if", "data", "types", "ABENCDS", "1168687851", "ANNO"]
---
