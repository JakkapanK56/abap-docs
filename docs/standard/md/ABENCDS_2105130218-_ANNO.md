---
title: "ABENCDS_2105130218-_ANNO"
description: |
  ABENCDS_2105130218-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_2105130218-_ANNO.htm"
abapFile: "ABENCDS_2105130218-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "2105130218", "ANNO"]
---
...
This annotation gives a relative position of the StatusInfo for the annotated CDS element in the collection of StatusInfo on entity-level. Must be specified to allow interspersing extension elements via extend views.

You want to set the order, in which elements should be positioned in the UI. The value is set in 10 steps.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.statusInfo[ ].position`\\ **Scope** `#ELEMENT`\\ **Type** `DecimalFloat`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html