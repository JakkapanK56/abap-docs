...
description: |
  ABAPTYPES_ITAB - Standard ABAP language reference documentation
library: "standard"
...
[Modify the initial memory requirement only for nested tables](ABENINITIAL_MEMORY_REQU_GUIDL.html)
