...
description: |
  ABAPCONVERT_TIME-STAMP - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPCONVERT_TIME-STAMP.htm"
...
-   The current user time zone can be found in the system field [`sy-zonlo`](ABENTIME_SYSTEM_FIELDS.html).
