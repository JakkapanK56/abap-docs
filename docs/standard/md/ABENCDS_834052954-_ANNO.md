---
title: "ABENCDS_834052954-_ANNO"
description: |
  ABENCDS_834052954-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_834052954-_ANNO.htm"
abapFile: "ABENCDS_834052954-_ANNO.html"
keywords: ["do", "if", "case", "data", "types", "ABENCDS", "834052954", "ANNO"]
---
...
This annotation groups and uniquely identifies annotations. You need to specify a qualifier as name of a chart to ensure that the correct chart can be referenced by the UI.
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.chart[ ].qualifier`\\ **Scope** `#ENTITY`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html