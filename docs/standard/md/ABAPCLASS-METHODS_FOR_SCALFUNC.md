...
description: |
  ABAPCLASS-METHODS_FOR_SCALFUNC - Standard ABAP language reference documentation
library: "standard"
...
For an example for the definition, implementation, and use of a CDS scalar function, see the topic [CDS FDL - `DEFINE SCALAR FUNCTION`](ABENCDS_DEFINE_SCALAR_FUNCTION.html).
