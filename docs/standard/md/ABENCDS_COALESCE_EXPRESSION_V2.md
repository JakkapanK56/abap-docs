...
description: |
  ABENCDS_COALESCE_EXPRESSION_V2 - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_COALESCE_EXPRESSION_V2.htm"
...
The valid argument types for `arg1` and `arg2` are all [dictionary types](ABENDDIC_BUILTIN_TYPES.html) except `ACCP`, `DF16_SCL` (obsolete), `DF34_SCL` (obsolete), `DF16_DEC`, `DF34_DEC`, `DF16_RAW`, `DF34_RAW`, `LCHR`, `LRAW`, `PREC`, `RAWSTRING`, `STRING`, and `GEOM_EWKB`.
