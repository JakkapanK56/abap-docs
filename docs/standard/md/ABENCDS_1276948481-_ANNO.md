...
title: "No KTD found"
description: |
  This annotation defines the preferred visualization of a data point. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.kpi .dataPoint.visualization` Scope `#ELEMENT` Type `String(12)` Enums `#BULLET_CHART, #DONUT, #NUMBER, #PROGRESS, #RA
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1276948481-_ANNO.htm"
abapFile: "ABENCDS_1276948481-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1276948481", "ANNO"]
---
