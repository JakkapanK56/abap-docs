...
title: "ABAPDATA"
description: |
  ABAPDATA - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPDATA.htm"
abapFile: "ABAPDATA.html"
keywords: ["do", "if", "class", "data", "types", "internal-table", "ABAPDATA"]
---
...
8\. `DATA dtype TYPE dbtab|view [READ-ONLY]\ [lob_handle_type](ABAPTYPES_LOB_HANDLE_TYPE.html) FOR [lob_handle_columns](ABAPTYPES_LOB_HANDLE_COLUMNS.html)\ [[lob_handle_type](ABAPTYPES_LOB_HANDLE_TYPE.html) FOR [lob_handle_columns](ABAPTYPES_LOB_HANDLE_COLUMNS.html) ... ].`
...
[LOB Handle Structures](ABAPDATA_LOB_HANDLE.html)
...
-   An obsolete variant [`DATA ... COMMON PART`](ABAPDATA_COMMON.html) declares interface work areas.
