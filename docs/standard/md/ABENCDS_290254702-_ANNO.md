---
title: "ABENCDS_290254702-_ANNO"
description: |
  ABENCDS_290254702-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_290254702-_ANNO.htm"
abapFile: "ABENCDS_290254702-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "290254702", "ANNO"]
---
...
This annotation defines further actions to a chart.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.chart[ ].actions[ ].type`\\ **Scope** `#ENTITY`\\ **Type** `String(40)`\\ **Enums** `#FOR_ACTION, #FOR_INTENT_BASED_NAVIGATION`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html