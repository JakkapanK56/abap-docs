...
description: |
  ABAPRAISE_SHORTDUMP - Standard ABAP language reference documentation
library: "standard"
...
The [short dump](ABENSHORT_DUMP_GLOSRY.html) of the runtime error contains the name of the exception class and the [exception text](ABENEXCEPTION_TEXT_GLOSRY.html). The attributes of the exception object can be listed in the transaction `ST22`. Under *Chain of Exception Objects*, the long text of the short dump contains the attributes referenced in the attribute `PREVIOUS` of the exception object.
