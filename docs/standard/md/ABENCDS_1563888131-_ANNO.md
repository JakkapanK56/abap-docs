...
title: "No KTD found"
description: |
  This annotation defines the dimensions used in a chart. This annotation must reference an element that is contained in UI.chart.dimensions. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.chart .dimensionAttributes .dimension` Scope `#ENTITY`
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1563888131-_ANNO.htm"
abapFile: "ABENCDS_1563888131-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1563888131", "ANNO"]
---
...
This annotation defines the dimensions used in a chart. This annotation must reference an element that is contained in UI.chart.dimensions.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.chart[ ].dimensionAttributes[ ].dimension`\\ **Scope** `#ENTITY`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html