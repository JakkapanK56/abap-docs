---
title: "ABENCDS_1166724647-_ANNO"
description: |
  ABENCDS_1166724647-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1166724647-_ANNO.htm"
abapFile: "ABENCDS_1166724647-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1166724647", "ANNO"]
---
...
This annotation contains the path to association element. The path is converted to an OData NavigationPropertyPath.

You want to provide background information to an item that is opened on the object view floorplan.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.statusInfo[ ].targetElement`\\ **Scope** `#ELEMENT`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html