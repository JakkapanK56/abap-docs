...
description: |
  ABENNEWS-752-ABAP_CDS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-752-ABAP_CDS.htm"
...
From ABAP release 7.52, it is possible to define [CDS annotations](ABENCDS_ANNOTATION_GLOSRY.html) as standalone [CDS objects](ABENCDS_OBJECT_GLOSRY.html) using the statement [`DEFINE ANNOTATION`](ABENCDS_F1_DEFINE_ANNOTATION.html) in [DDLA source code](ABENDDLA_SOURCE_CODE_GLOSRY.html).
