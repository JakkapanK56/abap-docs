...
description: |
  ABENCDS_PROJ_VIEW_EXPOSE_ASSOC - Standard ABAP language reference documentation
library: "standard"
...
-   Projected CDS associations, to-child, and to-parent associations can be specified as values for the CDS annotations [`ElementRef`](ABENCDS_F1_DEFINE_ANNOTATION_TYPE.html) and [`AssociationRef`](ABENCDS_F1_DEFINE_ANNOTATION_TYPE.html).
