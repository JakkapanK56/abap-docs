...
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1082641577-_ANNO.htm"
abapFile: "ABENCDS_1082641577-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1082641577", "ANNO"]
---
...
You want to display the annotation as an icon. To set the icon you need to link the icon image via an URL.
