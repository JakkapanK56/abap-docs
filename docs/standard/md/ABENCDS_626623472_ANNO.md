...
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_626623472_ANNO.htm"
abapFile: "ABENCDS_626623472_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "626623472", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `OData.applySupportedForAggregation`\\ **Scope** `#ENTITY`\\ **Type** `String(12)`\\ **Enums** `#FULL, #NONE, #RESTRICTED`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_odata\_f.html