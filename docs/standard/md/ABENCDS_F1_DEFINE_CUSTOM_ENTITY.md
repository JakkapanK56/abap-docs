...
description: |
  ABENCDS_F1_DEFINE_CUSTOM_ENTITY - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_F1_DEFINE_CUSTOM_ENTITY.htm"
...
-   No ABAP Dictionary [DDIC structure](ABENDDIC_STRUCTURES.html) visible in the [tools](ABENDDIC_TOOLS.html) for structures is created for a CDS custom entity.
