...
description: |
  ABAPRAISE_EXCEPTION_MESSAGE - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "error-handling"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPRAISE_EXCEPTION_MESSAGE.htm"
...
Raising of the exception `CX_DEMO_DYN_T100` that implements the interface `IF_T100_DYN_MSG`. The addition `USING MESSAGE` implicitly passes the properties of a [status message](ABENSTATUS_MESSAGE_GLOSRY.html) that was previously output with the statement [`MESSAGE`](ABAPMESSAGE.html).
...
-   For the latter, see the [executable example](ABENMESSAGE_INTERFACE_REUSE_ABEXA.html).
...
-   [Converting a Classic Example to a Class-Based Exception](ABENRAISE_MESSAGE_GLBL_SHRT_ABEXA.html)
