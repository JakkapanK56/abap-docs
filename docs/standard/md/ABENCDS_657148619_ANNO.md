...
title: "No KTD found"
description: |
  Runtime As an association annotation, this annotation is relevant for associations to temporal CDS views that do not bind the temporal key of the target in their on-condition. The annotation indicated that in consumption scenarios with key-date semantics, the association should be filtered with the
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_657148619_ANNO.htm"
abapFile: "ABENCDS_657148619_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "657148619", "ANNO"]
---
...
As an association annotation, this annotation is relevant for associations to temporal CDS views that do not bind the temporal key of the target in their on-condition. The annotation indicated that in consumption scenarios with key-date semantics, the association should be filtered with the key date.

As a view annotation, this annotation indicated that the view should be consumed at a key date.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.filter.businessDate.at`\\ **Scope** `#ELEMENT`, `#ENTITY`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html