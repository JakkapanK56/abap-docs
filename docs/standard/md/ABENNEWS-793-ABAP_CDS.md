...
description: |
  ABENNEWS-793-ABAP_CDS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-793-ABAP_CDS.htm"
...
The new [CDS object](ABENCDS_OBJECT_GLOSRY.html) is available: the [CDS scalar function](ABENCDS_SCALAR_FUNCTION_GLOSRY.html). It is defined using the [CDS FDL](ABENCDS_FDL_GLOSRY.html) statement [`DEFINE SCALAR FUNCTION`](ABENCDS_DEFINE_SCALAR_FUNCTION.html).
