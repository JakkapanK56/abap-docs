...
description: |
  ABENCDS_F1_DDL_SYNTAX - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_F1_DDL_SYNTAX.htm"
...
-   Statements for [CDS aspects](ABENCDS_DDL_ASPECT_GLOSRY.html):
...
-   DDL source code can also be displayed in the [Repository Browser](ABENREPOSITORY_BROWSER_GLOSRY.html) in [ABAP Workbench](ABENABAP_WORKBENCH_GLOSRY.html).
