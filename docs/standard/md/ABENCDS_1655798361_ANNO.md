...
title: "No KTD found"
description: |
  No KTD found No KTD found Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Semantics.spatialData.srid.value` Scope `#ELEMENT`, `#PARAMETER` Type `String(20)` Enums `-` Default `-` Text `-` MDE `-` API `-` abenabap.htm
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1655798361_ANNO.htm"
abapFile: "ABENCDS_1655798361_ANNO.html"
keywords: ["do", "while", "if", "data", "types", "ABENCDS", "1655798361", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Semantics.spatialData.srid.value`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `String(20)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_semantics\_f.html