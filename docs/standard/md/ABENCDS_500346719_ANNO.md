---
title: "ABENCDS_500346719_ANNO"
description: |
  ABENCDS_500346719_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_500346719_ANNO.htm"
abapFile: "ABENCDS_500346719_ANNO.html"
keywords: ["select", "do", "if", "case", "data", "ABENCDS", "500346719", "ANNO"]
---
...
You need to specify a qualifier as name of a selection variant to ensure that the correct selection variant can be referenced by the selection presentation variant.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.selectionPresentationVariant[ ].selectionVariantQualifier`\\ **Scope** `#ENTITY`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html