...
description: |
  ABENCDS_PROPAGATE_BUFFER - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_PROPAGATE_BUFFER.htm"
...
-   Buffer propagation is not always used, even if specified. Whether propagation takes place or not can be checked [SQL Trace](ABENSQL_TRACE_GLOSRY.html) of the [Performance Trace](ABENPERFORMANCE_TRACE_GLOSRY.html) tool (transaction `ST05`).
