---
title: "ABENCDS_289507703_ANNO"
description: |
  ABENCDS_289507703_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_289507703_ANNO.htm"
abapFile: "ABENCDS_289507703_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "289507703", "ANNO"]
---
...
This annotation supports the same scenario as the labelElement annotation. Using this annotation, the identifier”-elements are enriched with the information of elements containing the corresponding long texts. A quickInfoElement-annotation implies a group-WithElement-annotation of the “text”-element pointing to the “identifier”-element.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.quickInfoElement`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html