---
title: "ABENCDS_1309545091-_ANNO"
description: |
  ABENCDS_1309545091-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1309545091-_ANNO.htm"
abapFile: "ABENCDS_1309545091-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1309545091", "ANNO"]
---
...
This annotation sets a reference to an element and defines, what the status of the data is.

You want to show how different data develops. For this the criticality annotation can be used.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.lineItem[ ].criticality`\\ **Scope** `#ELEMENT`, `#ENTITY`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html