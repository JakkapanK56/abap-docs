---
title: "ABENCDS_1959431186_ANNO"
description: |
  ABENCDS_1959431186_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1959431186_ANNO.htm"
abapFile: "ABENCDS_1959431186_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1959431186", "ANNO"]
---
...
This annotation is used in combination with defaultValue to specify a default interval for a filter of a view element. In this case, the defaultValue contains the lower, defaultValueHigh the upper boundary of the interval.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.filter.defaultValueHigh`\\ **Scope** `#ELEMENT`\\ **Type** `String(1024)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html