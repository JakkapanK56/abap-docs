---
title: "ABENCDS_60965745_ANNO"
description: |
  ABENCDS_60965745_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_60965745_ANNO.htm"
abapFile: "ABENCDS_60965745_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "60965745", "ANNO"]
---
...
Id for parameters wherefore data has to be provided at runtime.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.ranking.functionParameterBinding[ ].parameterId`\\ **Scope** `#ELEMENT`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html