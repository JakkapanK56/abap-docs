---
title: "ABENSELECT_INTO_NEW_TABLE_ABEXA"
description: |
  ABENSELECT_INTO_NEW_TABLE_ABEXA - Standard ABAP language reference documentation
library: "standard"
...
keywords: ["select", "if", "try", "catch", "method", "class", "data", "internal-table", "ABENSELECT", "INTO", "NEW", "TABLE", "ABEXA"]
---
