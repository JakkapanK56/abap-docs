...
description: |
  ABAPCREATE_OBJECT - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPCREATE_OBJECT.htm"
...
1\. `CREATE OBJECT oref [[area_handle](ABAPCREATE_OBJECT_AREA_HANDLE.html)]\ [[parameter_list](ABAPCREATE_OBJECT_PARAMETERS.html)].`

2\. `CREATE OBJECT oref [[area_handle](ABAPCREATE_OBJECT_AREA_HANDLE.html)]\ TYPE \{ class [[parameter_list](ABAPCREATE_OBJECT_PARAMETERS.html)]\ \}\ |\ \{ (name) [[parameter_list](ABAPCREATE_OBJECT_PARAMETERS.html)|[parameter_tables](ABAPCREATE_OBJECT_PARA_TABLES.html)]\ \}.`
...
Also, if no more methods of the object are registered as event handlers, it is deleted by the [Garbage Collector](ABENGARBAGE_COLLECTOR_GLOSRY.html). The addition [`area_handle`](ABAPCREATE_OBJECT_AREA_HANDLE.html) can be used to create the object as a [shared object](ABENSHARED_OBJECT_GLOSRY.html).
