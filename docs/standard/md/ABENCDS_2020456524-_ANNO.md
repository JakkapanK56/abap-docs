---
title: "ABENCDS_2020456524-_ANNO"
description: |
  ABENCDS_2020456524-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_2020456524-_ANNO.htm"
abapFile: "ABENCDS_2020456524-_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "2020456524", "ANNO"]
---
...
This is used to indicate that several lines (aka “rows”) can be entered on the filter input (selection) UIs combined with the selectionType you get.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `AnalyticsDetails.variable.multipleSelections`\\ **Scope** `#PARAMETER`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_analyticsdetails\_f.html