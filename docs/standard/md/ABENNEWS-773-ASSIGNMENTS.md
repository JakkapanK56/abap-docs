...
description: |
  ABENNEWS-773-ASSIGNMENTS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-773-ASSIGNMENTS.htm"
abapFile: "ABENNEWS-773-ASSIGNMENTS.html"
keywords: ["do", "while", "data", "types", "ABENNEWS", "773", "ASSIGNMENTS"]
---
...
Before [only Unicode systems](ABENNEWS-762-UNICODE.html) were supported, the conversion rules for structures had to respect all possible alignment requirements for characters, regardless of the actual length of a character in its character representation.
