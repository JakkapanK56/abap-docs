---
title: "ABENCDS_1525932436_ANNO"
description: |
  ABENCDS_1525932436_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1525932436_ANNO.htm"
abapFile: "ABENCDS_1525932436_ANNO.html"
keywords: ["select", "do", "if", "case", "data", "ABENCDS", "1525932436", "ANNO"]
---
...
You want to specify a qualifier as name of a presentation variant to ensure that the correct presentation variant can be referenced by the selection presentation variant.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.selectionPresentationVariant[ ].presentationVariantQualifier`\\ **Scope** `#ENTITY`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html