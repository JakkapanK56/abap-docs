...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Consumption.valueHelpDefinition .selectionVariantQualifier` Scope `#ELEMENT`, `#PARAMETER` Type `String(120)` Enums `-` Default `-` Text `-` MDE `X` API `-` abenabap.
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1522836018-_ANNO.htm"
abapFile: "ABENCDS_1522836018-_ANNO.html"
keywords: ["select", "do", "if", "data", "types", "ABENCDS", "1522836018", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.valueHelpDefinition[ ].selectionVariantQualifier`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html