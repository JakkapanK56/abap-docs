...
description: |
  ABENDDIC_DATABASE_TABLES_CHECKTAB - Standard ABAP language reference documentation
library: "standard"
...
-   A special column can be used to [flag obsolete data](ABENDDIC_DEPRECATION.html) in check tables.
