...
title: "No KTD found"
description: |
  This annotation specifies the displayed format of the value. You want to display the value in an individual way, such as displaying 1000 as 'k' then you can use scaleFactor in order to achieve this. Additionally you can use numberOfFractionalDigits to set how many digits of a number should be displa
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1025842294_ANNO.htm"
abapFile: "ABENCDS_1025842294_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1025842294", "ANNO"]
---
...
You want to display the value in an individual way, such as displaying 1000 as 'k' then you can use scaleFactor in order to achieve this.

Additionally you can use numberOfFractionalDigits to set how many digits of a number should be displayed.

This annotation adds a scale factor to the displayed value.

For example, if the value reaches 1000, adding a scale factor can display this value as 1k.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.kpi[ ].dataPoint.valueFormat.scaleFactor`\\ **Scope** `#ELEMENT`\\ **Type** `DecimalFloat`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html