---
title: "ABENCDS_1143047081_ANNO"
description: |
  ABENCDS_1143047081_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1143047081_ANNO.htm"
abapFile: "ABENCDS_1143047081_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1143047081", "ANNO"]
---
...
This annotated property contains a measured quantity. In case the user enters more fractional digits than defined for the corresponding unit of measure, the validation of user input with respect to decimals is switched off.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.doNotCheckScaleOfMeasuredQuantity`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html