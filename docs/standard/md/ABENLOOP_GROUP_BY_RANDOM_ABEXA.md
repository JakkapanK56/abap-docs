---
title: "ABENLOOP_GROUP_BY_RANDOM_ABEXA"
description: |
  ABENLOOP_GROUP_BY_RANDOM_ABEXA - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENLOOP_GROUP_BY_RANDOM_ABEXA.htm"
abapFile: "ABENLOOP_GROUP_BY_RANDOM_ABEXA.html"
keywords: ["loop", "do", "method", "class", "data", "internal-table", "ABENLOOP", "GROUP", "RANDOM", "ABEXA"]
---

This example demonstrates a construction of the [group key](ABENGROUP_KEY_GLOSRY.html) that does not depend on the table lines.
