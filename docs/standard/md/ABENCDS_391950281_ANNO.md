...
title: "No KTD found"
description: |
  This annotation references a value that is set as a forecast value. Note: Can be set as predicted or intended quarterly results. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.kpi .dataPoint.forecastValue` Scope `#ELEMENT` Type `DecimalFl
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_391950281_ANNO.htm"
abapFile: "ABENCDS_391950281_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "391950281", "ANNO"]
---
...
This annotation references a value that is set as a forecast value.

*Note: Can be set as predicted or intended quarterly results.*

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.kpi[ ].dataPoint.forecastValue`\\ **Scope** `#ELEMENT`\\ **Type** `DecimalFloat`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html