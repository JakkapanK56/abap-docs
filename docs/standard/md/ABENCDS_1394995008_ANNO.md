---
title: "ABENCDS_1394995008_ANNO"
description: |
  ABENCDS_1394995008_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1394995008_ANNO.htm"
abapFile: "ABENCDS_1394995008_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "1394995008", "ANNO"]
---
...
If this is set to true, the parameter represents a list of hierarchy nodes which belong to the same hierarchy.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.hierarchyNodeSelection.multipleSelections`\\ **Scope** `#PARAMETER`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html