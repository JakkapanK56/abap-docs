...
description: |
  ABENNEWS-758-CDS_BDL - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNEWS-758-CDS_BDL.htm"
...
[17\. BOPF-Based RAP Business Objects](#ABAP_MODIFICATION_17@4@)
...
A migration tool has been released to migrate [CDS-based BOPF business objects](ABENCDS_BOPF_BO_GLOSRY.html) to [BOPF-based RAP business objects](ABENRAP_BOPF_BO_GLOSRY.html). For details on BOPF-based RAP business objects, see the topic [RAP - BOPF-Based RAP Business Objects](ABENBDL_RAP_BOPF.html).
