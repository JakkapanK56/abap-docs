...
title: "No KTD found"
description: |
  This annotation specifies what hierarchy type is used different values determine which CDS elements are required or available. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.identification .type` Scope `#ELEMENT` Type `String(40)` Enums
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1239070146-_ANNO.htm"
abapFile: "ABENCDS_1239070146-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1239070146", "ANNO"]
---
