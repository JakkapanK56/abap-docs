---
title: "ABENCDS_1543997474_ANNO"
description: |
  ABENCDS_1543997474_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1543997474_ANNO.htm"
abapFile: "ABENCDS_1543997474_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1543997474", "ANNO"]
---
...
This annotation refers to a UI.presentationVariant annotation at the same view via its qualifier.

You want to initially represent the KPI detail.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.kpi[ ].detail.defaultPresentationVariantQualifier`\\ **Scope** `#ELEMENT`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html