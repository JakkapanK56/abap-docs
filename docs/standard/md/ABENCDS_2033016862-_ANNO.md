...
title: "No KTD found"
description: |
  This annotation contains the qualifier of the referenced annotation. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.facet .targetQualifier` Scope `#ELEMENT` Type `String(120)` Enums `-` Default `-` Text `-` MDE `X`
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_2033016862-_ANNO.htm"
abapFile: "ABENCDS_2033016862-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "2033016862", "ANNO"]
---
...
This annotation contains the qualifier of the referenced annotation.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.facet[ ].targetQualifier`\\ **Scope** `#ELEMENT`\\ **Type** `String(120)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html