...
description: |
  ABAPSELECT_INDICATORS - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABAPSELECT_INDICATORS.htm"
abapFile: "ABAPSELECT_INDICATORS.html"
keywords: ["select", "insert", "delete", "do", "while", "if", "case", "catch", "method", "class", "data", "types", "internal-table", "ABAPSELECT", "INDICATORS"]
---
...
The addition `INDICATORS` is not supported by all databases. In an ABAP program, it is possible to use the method `USE_FEATURES` of the class [`CL_ABAP_DBFEATURES`](ABENCL_ABAP_DBFEATURES.html) to check whether the current database system or a database system accessed using a [secondary connection](ABENSECONDARY_DB_CONNECTION_GLOSRY.html) supports the use of this addition. This requires the constant `INDICATORS` of this class to be passed to the method in an internal table.
