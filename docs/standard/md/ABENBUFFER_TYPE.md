...
description: |
  ABENBUFFER_TYPE - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENBUFFER_TYPE.htm"
...
-   For DDIC database tables and DDIC database views this is done as [part](ABENDDIC_DATABASE_TABLES_BUFFER.html) of their [technical settings](ABENDDIC_DATABASE_TABLES_TECHSPEC.html).
