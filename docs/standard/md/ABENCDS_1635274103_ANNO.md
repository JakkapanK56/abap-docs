...
title: "No KTD found"
description: |
  Reference to an element; valid element values are 1, 2, and 3. The criticality value 'Negative' is reflected by 1, the value 'Critical' by 2, and the value 'Positive' by 3. You want to show how different data develops. For this the criticality annotation can be used. Kind Framework-specific ann
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1635274103_ANNO.htm"
abapFile: "ABENCDS_1635274103_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1635274103", "ANNO"]
---
...
Reference to an element; valid element values are 1, 2, and 3. The criticality value 'Negative' is reflected by 1, the value 'Critical' by 2, and the value 'Positive' by 3.

You want to show how different data develops. For this the criticality annotation can be used.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.criticalityLabels[ ].criticality`\\ **Scope** `#ELEMENT`\\ **Type** `Integer`\\ **Enums** `#CRITICAL, #NEGATIVE, #POSITIVE`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html