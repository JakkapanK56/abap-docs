...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Consumption.valueHelpDefinition .association` Scope `#ELEMENT`, `#PARAMETER` Type `AssociationRef` Enums `-` Default `-` Text `-` MDE `X` API `-` abenabap.html abencd
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1532149211-_ANNO.htm"
abapFile: "ABENCDS_1532149211-_ANNO.html"
keywords: ["do", "if", "data", "types", "ABENCDS", "1532149211", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.valueHelpDefinition[ ].association`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `AssociationRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `-` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_consumption\_f.html