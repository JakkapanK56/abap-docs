---
title: "ABENCDS_1499292211-_ANNO"
description: |
  ABENCDS_1499292211-_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1499292211-_ANNO.htm"
abapFile: "ABENCDS_1499292211-_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1499292211", "ANNO"]
---
...
This annotation can be used to display the criticality with values such as 'neutral (0)' or 'critical (2)'.

This annotation can be used to display the criticality with arrows pointing up and down indicating the development of data.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.dataPoint.criticalityRepresentation`\\ **Scope** `#ELEMENT`\\ **Type** `String(12)`\\ **Enums** `#WITHOUT_ICON, #WITH_ICON`\\ **Default** `#WITHOUT_ICON`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html