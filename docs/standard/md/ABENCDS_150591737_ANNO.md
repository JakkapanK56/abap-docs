---
title: "ABENCDS_150591737_ANNO"
description: |
  ABENCDS_150591737_ANNO - Standard ABAP language reference documentation
library: "standard"
libraryName: "Standard ABAP"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_150591737_ANNO.htm"
abapFile: "ABENCDS_150591737_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "150591737", "ANNO"]
---
...
This annotation sets the possibility to mask for example passwords or paraphrases.

You want to mask text fields. With UI.masked the UI may offer to show the clear text upon explicit user interaction.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.masked`\\ **Scope** `#ELEMENT`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html