...
title: "No KTD found"
description: |
  No KTD found Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.chart .dimensionAttributes .emphasizedValues` Scope `#ENTITY` Type `String(1024)` Enums `-` Default `-` Text `-` MDE `X` API `RELEASED_FOR_KEY_USE
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1802805886_ANNO.htm"
abapFile: "ABENCDS_1802805886_ANNO.html"
keywords: ["do", "if", "case", "data", "ABENCDS", "1802805886", "ANNO"]
---
