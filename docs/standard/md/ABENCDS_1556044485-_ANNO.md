...
title: "No KTD found"
description: |
  This annotation creates a title for the badge. It is a required DataField restricted to the types, WITH_NAVIGATION_PATH, and WITH_URL. This annotation refers to a value. If you refer to a value that is in the same view, specify the element name. If you use an association to refer to a value,
library: "standard"
libraryName: "Standard ABAP"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENCDS_1556044485-_ANNO.htm"
abapFile: "ABENCDS_1556044485-_ANNO.html"
keywords: ["do", "if", "data", "types", "ABENCDS", "1556044485", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.badge.title.value`\\ **Scope** `#ENTITY`\\ **Type** `ElementRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM` abenabap.html abencds.html abencds\_annotations.html abencds\_annotations\_sap.html abencds\_annotations\_ktd\_docu.html abencds\_frmwrk\_annos.html abencds\_ui\_f.html