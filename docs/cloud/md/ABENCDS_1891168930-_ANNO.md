...
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_1891168930-_ANNO.htm"
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.headerInfo.title.criticalityRepresentation`\\ **Scope** `#ENTITY`\\ **Type** `String(12)`\\ **Enums** `#WITHOUT_ICON, #WITH_ICON`\\ **Default** `#WITHOUT_ICON`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`