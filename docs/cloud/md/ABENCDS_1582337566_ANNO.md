...
title: "No KTD found"
description: |
  No KTD found Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `EnterpriseSearch.nls.variantElements .arrayAlternativeNames .alternativeName` Scope `#ENTITY` Type `String(128)` Enums `-` Default `-` Text `X` MDE `X` A
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_1582337566_ANNO.htm"
abapFile: "ABENCDS_1582337566_ANNO.html"
keywords: ["do", "if", "ABENCDS", "1582337566", "ANNO"]
---
...
The annotation defines a group of fields that denote variants of the same subject.

No KTD found

No KTD found

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `EnterpriseSearch.nls.variantElements[ ].arrayAlternativeNames[ ].alternativeName`\\ **Scope** `#ENTITY`\\ **Type** `String(128)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `X`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`