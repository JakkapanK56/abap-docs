...
description: |
  ABENDATA_OBJECTS_USAGE_READING - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENDATA_OBJECTS_USAGE_READING.htm"
...
-   If the data object is an internal table, the expressions `dobj[]`, `<fs>[]`, or `dref->*[]` can also be used. An exception to this is specification of the internal table of a [table expression](ABENTABLE_EXPRESSION_GLOSRY.html), where `[]` cannot be appended to the name.
