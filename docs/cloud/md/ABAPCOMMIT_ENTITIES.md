...
description: |
  ABAPCOMMIT_ENTITIES - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPCOMMIT_ENTITIES.htm"
abapFile: "ABAPCOMMIT_ENTITIES.html"
keywords: ["delete", "loop", "do", "if", "case", "method", "class", "data", "ABAPCOMMIT", "ENTITIES"]
---
