...
title: "No KTD found"
description: |
  No KTD found Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `EnterpriseSearch.nls.compoundElements .arrayAlternativeNames .alternativeName` Scope `#ENTITY` Type `String(128)` Enums `-` Default `-` Text `X` MDE `X`
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_555084622-_ANNO.htm"
abapFile: "ABENCDS_555084622-_ANNO.html"
keywords: ["do", "if", "ABENCDS", "555084622", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `EnterpriseSearch.nls.compoundElements[ ].arrayAlternativeNames[ ].alternativeName`\\ **Scope** `#ENTITY`\\ **Type** `String(128)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `X`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`