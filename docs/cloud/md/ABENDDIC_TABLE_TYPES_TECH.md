...
description: |
  ABENDDIC_TABLE_TYPES_TECH - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENDDIC_TABLE_TYPES_TECH.htm"
...
-   The line type can be defined by referencing any [data type](ABENDDIC_DATA_TYPES.html), including [DDIC database tables](ABENDDIC_DATABASE_TABLES.html) and DDIC views.
