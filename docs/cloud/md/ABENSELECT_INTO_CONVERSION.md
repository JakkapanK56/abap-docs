...
description: |
  ABENSELECT_INTO_CONVERSION - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENSELECT_INTO_CONVERSION.htm"
abapFile: "ABENSELECT_INTO_CONVERSION.html"
keywords: ["select", "insert", "delete", "if", "class", "data", "types", "ABENSELECT", "INTO", "CONVERSION"]
---

The following assignment rules apply to assignments of the result fields of the result set of a standalone [`SELECT`](ABAPSELECT.html), [`WITH`](ABAPWITH.html), or `FETCH` statement to the target fields defined in the [`INTO`](ABAPINTO_CLAUSE.html) clause.
