...
description: |
  ABAPMODIFY_DBTAB - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPMODIFY_DBTAB.htm"
abapFile: "ABAPMODIFY_DBTAB.html"
keywords: ["insert", "update", "delete", "do", "if", "data", "internal-table", "ABAPMODIFY", "DBTAB"]
---

``MODIFY [`target`](ABAPIUMD_TARGET.html) FROM [`source`](ABAPMODIFY_SOURCE.html)\         [[`OPTIONS`](ABAPIUMD_OPTIONS.html)]\           [`PRIVILEGED ACCESS`]           [[`CONNECTION ...`](ABAPIUMD_CONN.html)].``
