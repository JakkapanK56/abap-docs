...
description: |
  ABENDDIC_DATABASE_TABLES_BUFFER - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENDDIC_DATABASE_TABLES_BUFFER.htm"
abapFile: "ABENDDIC_DATABASE_TABLES_BUFFER.html"
keywords: ["if", "try", "data", "types", "ABENDDIC", "DATABASE", "TABLES", "BUFFER"]
---
...
The table buffer is managed by the [database interface](ABENDATABASE_INTERFACE_GLOSRY.html). When tables with active buffering are accessed using [ABAP SQL](ABENABAP_SQL_GLOSRY.html), the table buffer is used implicitly.
