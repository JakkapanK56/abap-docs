...
description: |
  ABENCLIENT_DEPENDENT_GLOSRY - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCLIENT_DEPENDENT_GLOSRY.htm"
...
-   A [DDIC database table](ABENDDIC_DB_TABLE_GLOSRY.html)\\ [ABAP Dictionary](ABENABAP_DICTIONARY_GLOSRY.html) is client-dependent if the first column is a [client column](ABENCLIENT_COLUMN_GLOSRY.html). The system table `T000`, which contains the [AS ABAP](ABENAS_ABAP_GLOSRY.html)\\ [client IDs](ABENCLIENT_IDENTIFIER_GLOSRY.html), is an exception to this rule.
