...
description: |
  which can be specified at certain operand positions. In restricted ABAP language versions(ABENRESTRICTED_VERSION_GLOSRY.html) not all language elements can be used. The topic Language Elements in ABAP Versions provides an overview of the ABAP language elements that are allowed in restricted langua
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENABAP_STATEMENTS.htm"
abapFile: "ABENABAP_STATEMENTS.html"
keywords: ["delete", "do", "if", "case", "method", "data", "ABENABAP", "STATEMENTS"]
---
