...
description: |
  ABENABAP_XML_LIBS - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENABAP_XML_LIBS.htm"
...
-   There is an [iXML Library for ABAP Cloud](ABENABAP_IXML_LIB_CLOUD.html).
