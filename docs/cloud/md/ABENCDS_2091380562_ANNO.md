---
title: "ABENCDS_2091380562_ANNO"
description: |
  ABENCDS_2091380562_ANNO - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_2091380562_ANNO.htm"
abapFile: "ABENCDS_2091380562_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "2091380562", "ANNO"]
---
...
Element of the lookupEntity providing the upper limit of an interval (lower limit defined by resultElement).

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.derivation.resultElementHigh`\\ **Scope** `#ELEMENT`, `#PARAMETER`\\ **Type** `String(30)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`