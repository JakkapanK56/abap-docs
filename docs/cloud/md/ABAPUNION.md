...
title: "ABAPUNION"
description: |
  ABAPUNION - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPUNION.htm"
...
2.  For creating the result set of the [main query](ABENMAINQUERY_GLOSRY.html) after `OPEN CURSOR`.
