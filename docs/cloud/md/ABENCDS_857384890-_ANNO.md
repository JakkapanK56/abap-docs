...
description: |
  ABENCDS_857384890-_ANNO - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_857384890-_ANNO.htm"
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.textArrangement`\\ **Scope** `#ELEMENT`, `#ENTITY`\\ **Type** `String(13)`\\ **Enums** `#TEXT_FIRST, #TEXT_LAST, #TEXT_ONLY, #TEXT_SEPARATE`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`