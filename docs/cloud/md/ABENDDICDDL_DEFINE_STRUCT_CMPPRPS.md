...
description: |
  ABENDDICDDL_DEFINE_STRUCT_CMPPRPS - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENDDICDDL_DEFINE_STRUCT_CMPPRPS.htm"
...
-   `@AbapCatalog.textLanguage` - Flags a component of type `LANG` as text language
