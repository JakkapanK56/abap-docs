...
description: |
  ABENCDS_ELEMENT_ANNOTATIONS_V2 - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_ELEMENT_ANNOTATIONS_V2.htm"
...
This example demonstrates how element annotations are passed on between views via [CDS associations](ABENCDS_ASSOCIATION_GLOSRY.html). The following CDS view entity defines and exposes a CDS association `_some_assoc`:
