...
title: "ABENUTCLONG"
description: |
  ABENUTCLONG - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENUTCLONG.htm"
...
-   During formatting as a character string using [string templates](ABENSTRING_TEMPLATE_GLOSRY.html), an initial time stamp field creates a character string consisting of spaces.
