...
description: |
  ABENCDS_F1_ELEMENT_ANNOTATION - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_F1_ELEMENT_ANNOTATION.htm"
abapFile: "ABENCDS_F1_ELEMENT_ANNOTATION.html"
keywords: ["select", "do", "if", "try", "data", "types", "ABENCDS", "ELEMENT", "ANNOTATION"]
---
