...
description: |
  ABENNEWS-816-ABAP_CDS - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENNEWS-816-ABAP_CDS.htm"
...
[2\. Extended Cast Matrix](#ABAP_MODIFICATION_2@4@)

[3\. New Element Annotations](#ABAP_MODIFICATION_3@4@)

[4\. New Analytical Scalar Functions](#ABAP_MODIFICATION_4@4@)

[5\. CDS Propagated Buffer](#ABAP_MODIFICATION_5@4@)

[6\. CDS Aspects](#ABAP_MODIFICATION_6@4@)

[7\. CDS External Entities](#ABAP_MODIFICATION_7@4@)

[8\. Writable CDS External Entities](#ABAP_MODIFICATION_8@4@)

[9\. Static External Entities](#ABAP_MODIFICATION_9@4@)

[10\. Client Parameter in SQL Functions](#ABAP_MODIFICATION_10@4@)

[11\. Client Safety of CDS Table Functions](#ABAP_MODIFICATION_11@4@)

[12\. CDS Enumerated Elements in CDS Conditions](#ABAP_MODIFICATION_12@4@)

[13. Support of Data Types in Logical Expressions with `IS INITIAL`](#ABAP_MODIFICATION_13@4@)

[14\. CDS Delegated Buffers](#ABAP_MODIFICATION_14@4@)

[15\. Writable CDS View Entities](#ABAP_MODIFICATION_15@4@)

[16\. CDS Table Entities](#ABAP_MODIFICATION_16@4@)

[17\. CDS Table Entity, Table Buffering](#ABAP_MODIFICATION_17@4@)

[18\. CDS Service Definitions Can Now Expose AMDP Procedure Implementations](#ABAP_MODIFICATION_18@4@)

[19\. CDS Static Caches](#ABAP_MODIFICATION_19@4@)
...
With the first release of [CDS external entities](ABENCDS_EXTERNAL_ENTITY_GLOSRY.html), only [dynamic external entities](ABENCDS_DYNAMIC_EE_GLOSRY.html) were available. Now, also [static external entities](ABENCDS_STATIC_EE_GLOSRY.html) are available. They are defined using the addition [`PROVIDED BY logical_external_schema`](ABENCDS_DEFINE_EXTERNAL_ENTITY.html) in the data definition.
...
[CDS enumerated elements](ABENCDS_ENUM_ELEMENT_GLOSRY.html) are now also supported as left-hand operands in [logical expressions](ABENLOGICAL_EXPRESSION_GLOSRY.html). For more details, see the topic [CDS DDL - Using CDS Enumerated Types](ABENCDS_USE_ENUM_TYPE.html).
