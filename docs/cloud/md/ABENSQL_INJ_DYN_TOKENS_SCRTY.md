...
description: |
  ABENSQL_INJ_DYN_TOKENS_SCRTY - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENSQL_INJ_DYN_TOKENS_SCRTY.htm"
...
The dynamic forms of statements [`WITH`](ABAPWITH.html) and `OPEN CURSOR` enable the specification of all of the above clauses within one dynamic token. If all of part of the dynamic token originates from outside of the program, there is a risk of an SQL injection.
