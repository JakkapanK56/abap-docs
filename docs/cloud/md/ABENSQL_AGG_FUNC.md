...
description: |
  ABENSQL_AGG_FUNC - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENSQL_AGG_FUNC.htm"
...
The data type of the column must be numeric. The data types `DF16_RAW` and `DF34_RAW` are not allowed. The data type `INT8` is only allowed together with the addition [`AS dtype`](ABAPSELECT_AVG_AS.html).
