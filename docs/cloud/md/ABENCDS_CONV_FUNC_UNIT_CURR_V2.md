...
description: |
  ABENCDS_CONV_FUNC_UNIT_CURR_V2 - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_CONV_FUNC_UNIT_CURR_V2.htm"
...
The unit conversion is performed on the basis of the client-dependent rules saved in the DDIC database tables `T006...` of the package `SZME`.
