...
Output of a time and UTC time stamps with different time formats. By specifying a country that s available in the system table, the respective country-specific format is selected.
