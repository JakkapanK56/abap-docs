...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENSELECT_EXCEPT_CDS_PARA_ABEXA.htm"
abapFile: "ABENSELECT_EXCEPT_CDS_PARA_ABEXA.html"
keywords: ["select", "do", "if", "method", "class", "data", "ABENSELECT", "EXCEPT", "CDS", "PARA", "ABEXA"]
---

This example demonstrates a difference of a CDS view with input parameters.

This example uses a [common table expression](ABENCOMMON_TABLE_EXPRESSION_GLOSRY.html) and two `SELECT` statements joined using [`EXCEPT`](ABAPUNION.html) to access the following CDS view entity.
