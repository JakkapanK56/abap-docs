...
description: |
  ABENNEWS-816-EML - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENNEWS-816-EML.htm"
abapFile: "ABENNEWS-816-EML.html"
keywords: ["if", "case", "try", "method", "class", "types", "ABENNEWS", "816", "EML"]
---
...
[11\. Retry Feature for RAP Local Event Executions](#ABAP_MODIFICATION_11@4@)
...
An automatic retry feature is now available to ensure [RAP local events](ABENMETHOD_FOR_ENTITY_EVENT.html) execute in case of temporary issues like locks on RAP BO instances. The framework will attempt to retry up to three times. You can design your implementation for the framework to automatically retry event execution after a specified time.
