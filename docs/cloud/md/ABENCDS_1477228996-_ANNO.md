---
title: "ABENCDS_1477228996-_ANNO"
description: |
  ABENCDS_1477228996-_ANNO - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_1477228996-_ANNO.htm"
abapFile: "ABENCDS_1477228996-_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "1477228996", "ANNO"]
---
...
The upper boundary of the range. It is the maximum value that can be included in the selection.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `AnalyticsDetails.variable.defaultRanges[ ].high`\\ **Scope** `#PARAMETER`\\ **Type** `String(1024)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`