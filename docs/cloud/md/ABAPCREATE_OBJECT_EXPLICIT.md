...
description: |
  ABAPCREATE_OBJECT_EXPLICIT - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPCREATE_OBJECT_EXPLICIT.htm"
abapFile: "ABAPCREATE_OBJECT_EXPLICIT.html"
keywords: ["do", "if", "case", "method", "class", "data", "ABAPCREATE", "OBJECT", "EXPLICIT"]
---

``CREATE OBJECT oref [`area_handle`]                     TYPE \{ class  [[`parameter_list`](ABAPCREATE_OBJECT_PARAMETERS.html)]\ \}\                        |\ \{ (name) [[`parameter_list`](ABAPCREATE_OBJECT_PARAMETERS.html)|[`parameter_tables`](ABAPCREATE_OBJECT_PARA_TABLES.html)]\ \}.``
