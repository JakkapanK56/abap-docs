...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_1872835334-_ANNO.htm"
abapFile: "ABENCDS_1872835334-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1872835334", "ANNO"]
---
...
PATCH should be increased if important compatible changes were made to the internal implementation of the views which fix important issues known to the clients.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `DataIntegration.dataProduct.release.version.patch`\\ **Scope** `#SERVICE`\\ **Type** `Integer`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`