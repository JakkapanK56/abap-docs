...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_1773719941_ANNO.htm"
abapFile: "ABENCDS_1773719941_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1773719941", "ANNO"]
---
...
This annotation specifies how many digits after the decimal are displayed.

You want numbers to be displayed with one digit after decimal, so you choose the element value 1.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.kpi[ ].dataPoint.valueFormat.numberOfFractionalDigits`\\ **Scope** `#ELEMENT`\\ **Type** `Integer`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`