---
title: "ABENCDS_CAST_EXPRESSION_RULES_V1"
description: |
  ABENCDS_CAST_EXPRESSION_RULES_V1 - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_CAST_EXPRESSION_RULES_V1.htm"
abapFile: "ABENCDS_CAST_EXPRESSION_RULES_V1.html"
keywords: ["select", "do", "if", "case", "class", "data", "types", "ABENCDS", "CAST", "EXPRESSION", "RULES"]
---

The following sections describe the conversion rules for [cast expressions](ABENCDS_CAST_EXPRESSION_V1.html) in [CDS DDL](ABENCDS_DDL_GLOSRY.html).
...
-   There is no special handling for the special target type for numeric text `NUMC` and for the date/time types `DATS` and `TIMS`. It is advisable to only convert valid values. In the case of the target type `NUMC`, the built-in function [`LPAD`](ABENCDS_SQL_FUNCTIONS_CHARACTER_V1.html) can be used to create leading zeros.
