...
title: "Number"
description: |
  Phase What is executed Expected Result 1 MODIFY RAP create operation` && n ` Ok 2 MODIFY ABAP SQL ` && n `database modification Violation 4 SAVE ABAP SQL database ` && n `modification Ok 5 SAVE Commit Violation 6 SAVE RAP create operation` && n ` Violation 7 MODIFY Calling API tagged
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCL_ABAP_TX_ABEXA.htm"
...
**Note** The example can only be executed if the checkpoint group *CC\_STMT* is not active. If they are active, the demo execution is not possible choosing the *Execute* button in the system-internal ABAP Keyword Documentation as dynpro processing is involved triggering a runtime error.
...
\\ \\nCLASS cl\_demo\_cl\_abap\_tx DEFINITION \\n INHERITING FROM cl\_demo\_classrun \\n PUBLIC \\n CREATE PUBLIC. \\n PUBLIC SECTION. \\n METHODS main REDEFINITION. \\n DATA input TYPE i. \\n\\ \\n PRIVATE SECTION. \\n METHODS get\_html RETURNING VALUE(html) TYPE string. \\n DATA current\_phase TYPE cl\_abap\_behv\_aux=>t\_phase. \\nENDCLASS. \\n\\ \\n\* Public class implementation \\nCLASS cl\_demo\_cl\_abap\_tx IMPLEMENTATION. \\n METHOD main. \\n\\ \\n cl\_demo\_input=>new( \\n )->add\_text( get\_html( ) \\n )->add\_field( EXPORTING \\n text = \`Number\` \\n CHANGING \\n field = input \\n )->request( ). \\n\\ \\n IF input >= 7. \\n DATA(oref) = NEW cl\_demo\_classified\_apis( ). \\n ENDIF. \\n\\ \\n CASE input. \\n\\ \\n WHEN 1. \\n\\ \\n cl\_abap\_tx=>modify( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n MODIFY ENTITY demo\_managed\_root \\n CREATE AUTO FILL CID \\n FIELDS ( key\_field data\_field1\_root data\_field2\_root ) \\n WITH VALUE #( \\n ( key\_field = 1 \\n data\_field1\_root = \`abc\` \\n data\_field2\_root = \`def\` ) ) \\n MAPPED DATA(m) \\n FAILED DATA(f) \\n REPORTED DATA(r). \\n\\ \\n out->write( \`RAP create operation in MODIFY phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN 2. \\n\\ \\n cl\_abap\_tx=>modify( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n DELETE FROM demo\_tab\_root. "#EC CI\_NOWHERE \\n\\ \\n out->write( \`Database modification operation in MODIFY \` && \\n \`phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN 4. \\n\\ \\n cl\_abap\_tx=>save( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n DELETE FROM demo\_tab\_root. "#EC CI\_NOWHERE \\n\\ \\n out->write( \`Database modification operation in SAVE \` && \\n \`phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN 5. \\n\\ \\n cl\_abap\_tx=>save( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n COMMIT ENTITIES. \\n\\ \\n out->write( \`Commit in (late) SAVE phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN 6. \\n\\ \\n cl\_abap\_tx=>save( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n MODIFY ENTITY demo\_managed\_root \\n CREATE AUTO FILL CID \\n FIELDS ( key\_field data\_field1\_root data\_field2\_root ) \\n WITH VALUE #( \\n ( key\_field = 1 \\n data\_field1\_root = \`abc\` \\n data\_field2\_root = \`def\` ) ) \\n MAPPED m \\n FAILED f \\n REPORTED r. \\n\\ \\n out->write( \`RAP create operation in SAVE phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n\*\*\*\*\*\*\*\*\*\*\*\*\*\*\* Classified APIs \*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\* \\n\\ \\n "if\_abap\_tx\_complete \\n WHEN 7. \\n\\ \\n cl\_abap\_tx=>modify( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_complete( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_COMPLETE in MODIFY phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN 8. \\n\\ \\n cl\_abap\_tx=>save( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_complete( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_COMPLETE in SAVE phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN 9. \\n\\ \\n oref->meth\_complete( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_COMPLETE (no transactional context set)\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n "if\_abap\_tx\_read \\n WHEN 10. \\n\\ \\n cl\_abap\_tx=>modify( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_read( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_READ in MODIFY phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN 11. \\n\\ \\n cl\_abap\_tx=>save( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_read( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_READ in SAVE phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n "if\_abap\_tx\_modify \\n WHEN 12. \\n\\ \\n cl\_abap\_tx=>modify( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_modify( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_MODIFY in MODIFY phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN 13. \\n\\ \\n cl\_abap\_tx=>save( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_modify( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_MODIFY in SAVE phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n "if\_abap\_tx\_save \\n WHEN 14. \\n\\ \\n cl\_abap\_tx=>modify( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_save( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_SAVE in MODIFY phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN 15. \\n\\ \\n cl\_abap\_tx=>save( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_save( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_SAVE in SAVE phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n "if\_abap\_tx\_functional \\n WHEN 16. \\n\\ \\n cl\_abap\_tx=>modify( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_functional( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_FUNCTIONAL in MODIFY phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN 17. \\n\\ \\n cl\_abap\_tx=>save( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_functional( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_FUNCTIONAL in SAVE phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n "if\_abap\_tx\_surface \\n WHEN 18. \\n\\ \\n cl\_abap\_tx=>modify( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_surface( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_SURFACE in MODIFY phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN 19. \\n\\ \\n cl\_abap\_tx=>save( ). \\n\\ \\n current\_phase = cl\_abap\_behv\_aux=>get\_current\_phase( ). \\n\\ \\n oref->meth\_surface( ). \\n\\ \\n out->write( \`Calling API classified with \` && \\n \`IF\_ABAP\_TX\_SURFACE in SAVE phase\` ). \\n out->write( |Current phase: \\{ current\_phase \\}| ). \\n\\ \\n WHEN OTHERS. \\n out->write( \`Enter one of the prededfined numbers.\` ). \\n ENDCASE. \\n\\ \\n ENDMETHOD. \\n METHOD get\_html. \\n html = \\n \`
