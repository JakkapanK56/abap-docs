...
description: |
  ABENDDICDDL_DEFINE_DYNAMIC_CACHE - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENDDICDDL_DEFINE_DYNAMIC_CACHE.htm"
...
The name `cache_name` of a dynamic cache must comply with the [naming conventions for DDIC data types](ABENDDIC_TYPES_NAMES.html) and can have a maximum of 30 characters. The name is in the namespace of the [DDIC data types](ABENDDIC_DATA_TYPES.html) and must match the name of the `DTDC` source code.
