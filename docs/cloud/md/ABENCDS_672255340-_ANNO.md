---
title: "ABENCDS_672255340-_ANNO"
description: |
  ABENCDS_672255340-_ANNO - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_672255340-_ANNO.htm"
abapFile: "ABENCDS_672255340-_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "672255340", "ANNO"]
---
...
The lower boundary of the range. It is the minimum value that can be included in the selection.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `AnalyticsDetails.variable.defaultRanges[ ].low`\\ **Scope** `#PARAMETER`\\ **Type** `String(1024)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`