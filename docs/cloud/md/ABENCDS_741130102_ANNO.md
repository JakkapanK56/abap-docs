...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_741130102_ANNO.htm"
...
**Kind** [ABAP annotation](ABENABAP_ANNOTATION_GLOSRY.html)\\ **Syntax** `Aggregation.default`\\ **Scope** `#ELEMENT`\\ **Type** `String(30)`\\ **Enums** `#AVG, #COUNT_DISTINCT, #FORMULA, #MAX, #MIN, #NONE, #NOP, #SUM`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`