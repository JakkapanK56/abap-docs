...
description: |
  ABAPIMPORT_CONVERSION - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPIMPORT_CONVERSION.htm"
...
Without the addition `IGNORING STRUCTURE BOUNDARIES`, the structure `f1` in the byte string could not be imported into the structure `f2` since `f1` and `f2` are set up differently from substructures.
