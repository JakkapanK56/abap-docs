...
description: |
  ABENCREATE_OBJECTS - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCREATE_OBJECTS.htm"
...
Data objects and objects are created in the [internal session](ABENINTERNAL_SESSION_GLOSRY.html) of the current program by default, and only programs in the same internal session can access them.
