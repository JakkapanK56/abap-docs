...
description: |
  ABAPDATA_SECONDARY_KEY - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPDATA_SECONDARY_KEY.htm"
abapFile: "ABAPDATA_SECONDARY_KEY.html"
keywords: ["insert", "delete", "loop", "do", "if", "case", "data", "types", "internal-table", "ABAPDATA", "SECONDARY", "KEY"]
---
