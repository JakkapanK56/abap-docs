...
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENBDL_LINK_UNLINK_ACTION.htm"
...
-   The link action is required when the [foreign key](ABENFOREIGN_KEY_GLOSRY.html) relationship between instances cannot be established by setting the respective [foreign key](ABENFOREIGN_KEY_GLOSRY.html) through create or update operations.
