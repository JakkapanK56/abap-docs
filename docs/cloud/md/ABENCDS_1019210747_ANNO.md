...
title: "No KTD found"
description: |
  With this annotation, multiple cells in the UI which contain the same value will be merged to improve the user experience. Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `UI.identification .rowSpanForDuplicateValues` Scope `#ELEMENT` Type `Bool
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_1019210747_ANNO.htm"
abapFile: "ABENCDS_1019210747_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "1019210747", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `UI.identification[ ].rowSpanForDuplicateValues`\\ **Scope** `#ELEMENT`\\ **Type** `Boolean`\\ **Enums** `-`\\ **Default** `true`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`