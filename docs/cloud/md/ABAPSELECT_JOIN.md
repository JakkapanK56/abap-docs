...
description: |
  ABAPSELECT_JOIN - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPSELECT_JOIN.htm"
abapFile: "ABAPSELECT_JOIN.html"
keywords: ["select", "do", "if", "case", "data", "internal-table", "ABAPSELECT", "JOIN"]
---
...
Cross join of two database tables. Without the `WHERE` condition, the result set would be very large.
