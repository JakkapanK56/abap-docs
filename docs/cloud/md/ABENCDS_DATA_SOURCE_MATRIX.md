...
description: |
  ABENCDS_DATA_SOURCE_MATRIX - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_DATA_SOURCE_MATRIX.htm"
...
**\\
CDS entity/`FROM`** **CDS view entity** \\ **CDS transactional interface** **CDS table function** **CDS hierarchy** **Static external entity** **CDS DDIC-based view** **DDIC database table** \\ **\\ [DDIC database view](ABENDATABASE_VIEW_GLOSRY.html)** **DDIC external view**\\ **\\
[CDS view entity](ABENCDS_V2_VIEW_GLOSRY.html)** x - x x x x x - - **\\
...
CDS entity/association target** **CDS table entity** \\ **CDS view entity** \\ **CDS projection view** **CDS table function** **Static external entity** **CDS hierarchy** **CDS custom entity** \\ **CDS abstract entity** **CDS DDIC-based view** **DDIC database table** \\ **\\ [DDIC database view](ABENDATABASE_VIEW_GLOSRY.html)** **DDIC external view**\\ **\\
CDS table entity** x - - - x - - - - - - - **\\
CDS view entity** - x x x x x x x x x - - **\\
CDS transactional query** - x x x x x x x x x - - **\\
CDS custom entity** - x - x x x x x x x x - **\\
CDS abstract entity** - x - x x x x x x x x - **\\
CDS DDIC-based view** - x - x x x x x x x x x **\\
