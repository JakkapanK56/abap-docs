---
title: "ABENCDS_732025797_ANNO"
description: |
  ABENCDS_732025797_ANNO - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_732025797_ANNO.htm"
abapFile: "ABENCDS_732025797_ANNO.html"
keywords: ["delete", "do", "if", "data", "ABENCDS", "732025797", "ANNO"]
---
...
List of cube views, for which the comments are provided. At first only one view is allowed. This annotation must be used in a document storage view (i.e., CDS view with header annotation *@Analytics.dataCategory: #DOCSTORE*).

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Analytics.document.storageForEntity[ ]`\\ **Scope** `#ENTITY`, `#VIEW`\\ **Type** `EntityRef`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`