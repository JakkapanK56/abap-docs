...
description: |
  ABENCDS_ENUMERATION_TYPES - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_ENUMERATION_TYPES.htm"
abapFile: "ABENCDS_ENUMERATION_TYPES.html"
keywords: ["do", "method", "class", "data", "types", "ABENCDS", "ENUMERATION", "TYPES"]
---

A [CDS enumerated type](ABENCDS_ENUM_TYPE_GLOSRY.html) is a [CDS user-defined type](ABENCDS_USER_DEFINED_TYPE_GLOSRY.html) in [ABAP CDS](ABENABAP_CDS_GLOSRY.html) that defines an [enumerated type](ABENENUM_TYPE_GLOSRY.html). CDS enumerated types are defined with the following statement in [ADT](ABENADT_GLOSRY.html):
...
-   [CDS DDL - `DEFINE TYPE ENUM`](ABENCDS_DEFINE_ENUM_TYPE.html)
...
-   The [annotations](ABENCDS_ANNOTATION_GLOSRY.html) of a CDS user-defined type can be evaluated using the methods of the class `CL_DD_DDL_ANNOTATION_SERVICE`.
