...
description: |
  ABENCDS_26162021_ANNO - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_26162021_ANNO.htm"
...
**Kind** [ABAP annotation](ABENABAP_ANNOTATION_GLOSRY.html)\\ **Syntax** `EndUserText.quickInfo`\\ **Scope** `#ANNOTATE`, `#ELEMENT`, `#ENTITY_ASPECT`, `#ENUM_VALUE`, `#PARAMETER`, `#SIMPLE_TYPE`\\ **Type** `String(100)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `X`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`