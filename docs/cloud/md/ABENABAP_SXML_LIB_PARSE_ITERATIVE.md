...
description: |
  ABENABAP_SXML_LIB_PARSE_ITERATIVE - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENABAP_SXML_LIB_PARSE_ITERATIVE.htm"
abapFile: "ABENABAP_SXML_LIB_PARSE_ITERATIVE.html"
keywords: ["if", "case", "try", "method", "class", "data", "ABENABAP", "SXML", "LIB", "PARSE", "ITERATIVE"]
---
