...
description: |
  ABENCDS_61840010-_ANNO - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_61840010-_ANNO.htm"
...
**Kind** [ABAP annotation](ABENABAP_ANNOTATION_GLOSRY.html)\\ **Syntax** `AbapCatalog.deliveryClass`\\ **Scope** `#TABLE_ENTITY`\\ **Type** `String(30)`\\ **Enums** `#APPLICATION_DATA, #CUSTOMIZING_DATA, #LOCAL_DATA, #SYSTEM_ADMINISTRATIVE_DATA, #SYSTEM_DATA, #SYSTEM_EDITABLE_DATA`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_SAP_CLOUD_PLATFORM`