...
title: "ABAPASSERT"
description: |
  ABAPASSERT - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPASSERT.htm"
abapFile: "ABAPASSERT.html"
keywords: ["if", "case", "try", "catch", "method", "data", "types", "ABAPASSERT"]
---
...
The name of the checkpoint group must be specified directly, and the group must exist in the [repository](ABENREPOSITORY_GLOSRY.html).
...
DATA gui\_flag TYPE abap\_boolean. \\nCALL FUNCTION 'GUI\_IS\_AVAILABLE' \\n IMPORTING \\n return = gui\_flag. \\n\\ \\nASSERT gui\_flag = abap\_true. DATA gui\_flag TYPE abap\_boolean. \\nCALL FUNCTION 'GUI\_IS\_AVAILABLE' \\n IMPORTING \\n return = gui\_flag. \\n\\ \\nASSERT ID demo\_checkpoint\_group \\n CONDITION gui\_flag = abap\_true. DATA gui\_flag TYPE abap\_boolean. \\nCALL FUNCTION 'GUI\_IS\_AVAILABLE' \\n IMPORTING \\n return = gui\_flag. \\n\\ \\nASSERT ID demo\_checkpoint\_group \\n SUBKEY sy-uname \\n FIELDS 'Missing GUI' \\n CONDITION gui\_flag = abap\_true. DATA gui\_flag TYPE abap\_boolean. \\nCALL FUNCTION 'GUI\_IS\_AVAILABLE' \\n IMPORTING \\n return = gui\_flag. \\n\\ \\nASSERT CONDITION gui\_flag = abap\_true. abenabap.html abenabap\_reference.html abenprogram\_editing.html abenabap\_tests.html abencheckpoints.html