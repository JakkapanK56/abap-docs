...
description: |
  ABENCDS_ENUM_ABEXA - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_ENUM_ABEXA.htm"
abapFile: "ABENCDS_ENUM_ABEXA.html"
keywords: ["select", "do", "if", "method", "class", "data", "types", "ABENCDS", "ENUM", "ABEXA"]
---
