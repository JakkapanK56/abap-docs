---
title: "AMDP functions"
description: |
  The same rules apply to an AMDP function implementation that implements an CDS table function(ABENCDS_TABLE_FUNCTION_GLOSRY.html) as to the AMDP table functions for AMDP methods (described above), with the following differences: The AMDP table function(ABENAMDP_TABLE_FUNCTION_GLOSRY.html) define
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENAMDP_FUNCTION_METHODS.htm"
