...
description: |
  ABENCONDITIONAL_EXPRESSION_RESULT - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCONDITIONAL_EXPRESSION_RESULT.htm"
abapFile: "ABENCONDITIONAL_EXPRESSION_RESULT.html"
keywords: ["select", "delete", "do", "if", "try", "catch", "class", "data", "ABENCONDITIONAL", "EXPRESSION", "RESULT"]
---
