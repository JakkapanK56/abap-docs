...
description: |
  ABENCDS_F1_ANNOTATE_VIEW_PARA_LIST - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_F1_ANNOTATE_VIEW_PARA_LIST.htm"
abapFile: "ABENCDS_F1_ANNOTATE_VIEW_PARA_LIST.html"
keywords: ["select", "do", "if", "case", "data", "ABENCDS", "ANNOTATE", "VIEW", "PARA", "LIST"]
---
