...
description: |
  ABENCDS_SERVICE_BINDINGS - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_SERVICE_BINDINGS.htm"
abapFile: "ABENCDS_SERVICE_BINDINGS.html"
keywords: ["do", "if", "data", "types", "ABENCDS", "SERVICE", "BINDINGS"]
---
...
When a service binding is activated, it makes the business service accessible in accordance with the protocol used. This involves technologies such as [SAP Gateway](ABENSAP_GATEWAY_GLOSRY.html) and the [RAP query engine](ABENRAP_QUERY_ENGINE_GLOSRY.html).
