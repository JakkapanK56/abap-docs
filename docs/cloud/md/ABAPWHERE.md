...
title: "ABAPWHERE"
description: |
  ABAPWHERE - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPWHERE.htm"
...
Reading of all objects in the ABAP keyword documentation from the table `DOKIL` using a suitable `WHERE` condition. Messages of the code inspector regarding the bypassing of the table buffer are suppressed using [pseudo comments](ABENPSEUDO_COMMENT_GLOSRY.html).
