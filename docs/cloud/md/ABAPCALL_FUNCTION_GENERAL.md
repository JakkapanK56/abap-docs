...
description: |
  ABAPCALL_FUNCTION_GENERAL - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPCALL_FUNCTION_GENERAL.htm"
...
-   Literal or constant
-   If the data object `func` is specified as a [character literal](ABENTEXT_LITERAL_GLOSRY.html) or as a [constant](ABENCONSTANT_GLOSRY.html), it is evaluated as a statically specified object by tools such as the where-used list.
-   Variable
