...
title: "No KTD found"
description: |
  No KTD found Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `EnterpriseSearch.nls.arrayAlternativeNames .alternativeName` Scope `#ELEMENT`, `#ENTITY` Type `String(128)` Enums `-` Default `-` Text `X` MDE `X` API `R
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_228093718_ANNO.htm"
abapFile: "ABENCDS_228093718_ANNO.html"
keywords: ["do", "if", "ABENCDS", "228093718", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `EnterpriseSearch.nls.arrayAlternativeNames[ ].alternativeName`\\ **Scope** `#ELEMENT`, `#ENTITY`\\ **Type** `String(128)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `X`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`