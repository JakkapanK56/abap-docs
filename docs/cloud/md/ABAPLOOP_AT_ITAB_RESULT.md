...
description: |
  ABAPLOOP_AT_ITAB_RESULT - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPLOOP_AT_ITAB_RESULT.htm"
abapFile: "ABAPLOOP_AT_ITAB_RESULT.html"
keywords: ["insert", "delete", "loop", "do", "while", "if", "method", "data", "types", "internal-table", "field-symbol", "ABAPLOOP", "ITAB", "RESULT"]
---
