---
title: "ABENABAP_SYSTEM_GLOSRY"
description: |
  ABENABAP_SYSTEM_GLOSRY - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENABAP_SYSTEM_GLOSRY.htm"
abapFile: "ABENABAP_SYSTEM_GLOSRY.html"
keywords: ["if", "data", "ABENABAP", "SYSTEM", "GLOSRY"]
---
...
[**\-> More about**](ABENORGANIZATION_OF_MODULES.html)

-   ABAP-specific components of the [presentation layer](ABENPRESENTATION_LAYER_GLOSRY.html).
