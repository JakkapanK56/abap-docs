...
description: |
  ABENCDS_2063101229-_ANNO - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_2063101229-_ANNO.htm"
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `VDM.viewType`\\ **Scope** `#ENTITY`\\ **Type** `String(30)`\\ **Enums** `#BASIC, #COMPOSITE, #CONSUMPTION, #DERIVATION_FUNCTION, #EXTENSION,#TRANSACTIONAL`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`