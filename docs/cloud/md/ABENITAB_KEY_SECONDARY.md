...
description: |
  ABENITAB_KEY_SECONDARY - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENITAB_KEY_SECONDARY.htm"
...
-   If the system field `sy-tabix` is set in this type of access, and a sorted secondary key is used, the line number refers to the associated [secondary table index](ABENSECONDARY_TABLE_INDEX_GLOSRY.html). In statements that have not been enhanced by these additions, like [`SORT`](ABAPSORT_ITAB.html), [`COLLECT`](ABAPCOLLECT.html), or `PROVIDE`, secondary keys are not explicitly supported.
