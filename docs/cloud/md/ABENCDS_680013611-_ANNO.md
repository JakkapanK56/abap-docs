...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_680013611-_ANNO.htm"
...
**Kind** [ABAP annotation](ABENABAP_ANNOTATION_GLOSRY.html)\\ **Syntax** `AbapCatalog.dbHints[ ].dbSystem`\\ **Scope** `#VIEW`\\ **Type** `String(3)`\\ **Enums** `#ADA, #ALL, #ASE, #DB2, #DB4, #DB6, #HDB, #INF, #MSS, #ORA`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_SAP_CLOUD_PLATFORM`