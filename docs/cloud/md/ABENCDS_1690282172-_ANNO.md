...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Consumption.hierarchyNodeSelection.defaultHierarchyNode.nodeType` Scope `#PARAMETER` Type `String(40)` Enums `-` Default `-` Text `-` MDE `X` API `RELEASED_FOR_KEY_USER
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_1690282172-_ANNO.htm"
abapFile: "ABENCDS_1690282172-_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "1690282172", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.hierarchyNodeSelection.defaultHierarchyNode.nodeType`\\ **Scope** `#PARAMETER`\\ **Type** `String(40)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`