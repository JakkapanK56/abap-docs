...
description: |
  ABAPMODIFY_AUG_ENTITY_ENTITIES - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABAPMODIFY_AUG_ENTITY_ENTITIES.htm"
abapFile: "ABAPMODIFY_AUG_ENTITY_ENTITIES.html"
keywords: ["insert", "update", "do", "if", "case", "try", "method", "types", "ABAPMODIFY", "AUG", "ENTITY", "ENTITIES"]
---
...
Each operation can be followed by this clause. If the reference to instances from the original request is given through identical keys or `%cid_ref`, an explicit specification of the `RELATING` addition is not required.
...
Create requests on the projection layer, augmented by a create or create-by-association operation, only include the [`%cid`](ABAPDERIVED_TYPES_CID.html) values from the original create request in the [`mapped` response](ABAPEML_RESPONSE.html). `%cid` values generated from the augmentations are not included in the `mapped` response of the original request.
...
-   The example [ABAP EML - `MODIFY AUGMENTING`, `RELATING TO`](ABENEML_MODIFY_AUGM_RELATING_ABEXA.html) demonstrates the `RELATING TO` addition.
