...
title: "No KTD found"
description: |
  Kind Framework-specific annotation(ABENFRMWRK_ANNOTATION_GLOSRY.html) Syntax `Consumption.valueHelpDefault.binding.usage` Scope `#ELEMENT` Type `String(30)` Enums `#FILTER, #FILTER_AND_DISPLAY, #FILTER_AND_RESULT, #RESULT` Default `-` Text `-` MDE `X`
library: "cloud"
libraryName: "ABAP Cloud"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_27509916-_ANNO.htm"
abapFile: "ABENCDS_27509916-_ANNO.html"
keywords: ["do", "if", "data", "ABENCDS", "27509916", "ANNO"]
---
...
**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `Consumption.valueHelpDefault.binding.usage`\\ **Scope** `#ELEMENT`\\ **Type** `String(30)`\\ **Enums** `#FILTER, #FILTER_AND_DISPLAY, #FILTER_AND_RESULT, #RESULT`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `X`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`