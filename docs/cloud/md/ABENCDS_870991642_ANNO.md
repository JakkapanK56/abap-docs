---
title: "ABENCDS_870991642_ANNO"
description: |
  ABENCDS_870991642_ANNO - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENCDS_870991642_ANNO.htm"
abapFile: "ABENCDS_870991642_ANNO.html"
keywords: ["select", "do", "if", "data", "ABENCDS", "870991642", "ANNO"]
---
...
The annotation 'AnalyticsDetails.variable.defaultHierarch.node.element' is referring to the element in the hierarchy view.

**Kind** [Framework-specific annotation](ABENFRMWRK_ANNOTATION_GLOSRY.html)\\ **Syntax** `AnalyticsDetails.variable.defaultHierarchyNode.node[].element`\\ **Scope** `#PARAMETER`\\ **Type** `String(30)`\\ **Enums** `-`\\ **Default** `-`\\ **Text** `-`\\ **MDE** `-`\\ **API** `RELEASED_FOR_KEY_USER_APPS, RELEASED_FOR_SAP_CLOUD_PLATFORM`