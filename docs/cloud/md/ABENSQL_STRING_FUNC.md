...
description: |
  ABENSQL_STRING_FUNC - ABAP Cloud language reference documentation
library: "cloud"
libraryName: "ABAP Cloud"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/ABENSQL_STRING_FUNC.htm"
...
-   The types `STRING` and `RAWSTRING` are also allowed for `LENGTH`.
