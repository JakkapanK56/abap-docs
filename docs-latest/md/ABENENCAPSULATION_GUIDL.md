...
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENENCAPSULATION_GUIDL.html"
...
-   Mark classes that are not intended as superclasses as [`FINAL`](ABENINHERITANCE_GUIDL.md).
