...
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENSYST_FIELD_ACCESS_GUIDL.html"
...
The only system fields where it was allowed to change the field content (in an application program) are part of classic list processing. This should [no longer be used](ABENLIST_GUIDL.md).
