...
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENNAME_LANGU_GUIDL.html"
...
This rule applies regardless of the [original language chosen](ABENORIGINAL_LANGU_GUIDL.md).
