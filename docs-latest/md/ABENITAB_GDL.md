...
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENITAB_GDL.html"
...
-   [Secondary Keys](ABENSECONDARY_KEY_GUIDL.md)
-   [Initial Memory Requirement](ABENINITIAL_MEMORY_REQU_GUIDL.md)
-   [Sorted Filling](ABENSORT_GUIDL.md)
-   [Compressed Filling](ABENCOLLECT_GUIDL.md)
-   [Target Area](ABENTABLE_OUTPUT_GUIDL.md)
