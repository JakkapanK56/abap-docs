...
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/ABENSTRUCTURE_STYLE_GDL.html"
...
-   [Source Code Formatting](ABENFORMATTING_CODE_GDL.md)
-   [Naming](ABENNAMING_GDL.md)
-   [Comments](ABENCOMMENTS_GDL.md)
-   [Program and Procedure Structure](ABENPROGR_PROC_STRUCTURE_GDL.md)
-   [Source Code Organization](ABENSOURCE_CODE_ORGA_GDL.md)
-   [Alternative Spellings](ABENALTERNATIVE_SPELLING_GDL.md)
-   [Complexity](ABENCOMPLEXITY_GDL.md)
